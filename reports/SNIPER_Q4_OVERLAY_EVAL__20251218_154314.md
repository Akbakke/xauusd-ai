# SNIPER Q4 Overlay Evaluation (20251218_154314)
...
- Normal run: `gx1/wf_runs/SNIPER_OBS_Q4_2025_baseline_overlay_20251218_152108` (source: trades/*.json (CSV missing/empty))
...
| --- | ---: | ---: | ---: | ---: | ---: |
| normal | 4605 | 23.50 | 52.6% | 1.33 | 284.5 |
...
- Normal run: `gx1/wf_runs/SNIPER_OBS_Q4_2025_guarded_overlay_20251218_153815` (source: missing (no trade_journal_index.csv, no trades/*.json))
...
- normal: source=missing (no trade_journal_index.csv, no trades/*.json), pnl_coverage=0.0%, regime_coverage=0.0%
