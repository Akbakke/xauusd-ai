# HISTORIKK — IKKE GJELDENDE STARTINSTRUKSER

Bevart før samordnet overlevering 2026-09-16. Bruk CURRENT_HANDOVER.md.

## Reference32 består på GPU; split16+16 startbestilt — 2026-09-16
+
+Frosset/pushed kilde fcd03e884c2b402979624df767a359c57562c2e1 er uendret.
+Reference er ferdig påboot444 med guardPASS/trainer0/observer0 og signed receipt.
+32 faktiske optimizersteg fra5777→5809, checkpoint96, epoch1/offset1728/train.
+StateSHA77294b3f04afca6c0acb1e078fb68f392f6ba3ee0a1858a669a8c91b12622d0c.
+Minnerettelsen fungerer i faktisk native trening.512 TRAIN-rader behandlet.
+Løkken tok170.835s inklbatchfetch/forward/backward/optimizer,5.33859s/steg;
+med checkpointlagring174.233s. Hele bevoktedeinvokasjonen832s, hvor655.178s
+var før treningsløkken. Dette inkluderer ikke tidligere Windows-omstart/
+controllerforberedelse og er ingen relativspeedup eller full-epochETA.
+Guardtopp8224MiB,58Ccore/62Cmem/206.03W. Ingen grenser økt.
+Førstebatchdiagnostikk er før første oppdatering: Entry16FLAT hos elev/lærer;
+Exit-targets69positive/59negative. Dette er ikke post32-lærings-/profittbevis.
+
+Neste split16+16 er startbestilt i samme Windows-task, Running/Enabled;
+controllerprepare-rebootPID27676 var levende. SPLIT-planen er nybundet til
+nåværende boot444 slik at også første splitvindu må få en FRISK fysisk boot.
+Bruk bare CAMPAIGN_PREPARED_BOOT444/CAMPAIGN_PLAN.json under
+NATIVE_FROZEN_TRACE_MEMORY_FCD03E88_SPLIT, planSHA
+3dbfe55dc20af018bb1dbce52b5a4180bda66d448fddab980533ffd0317a145c,
+runtime /home/andre2/GX1_RUNS/NATIVE_FROZEN_TRACE_MEMORY_FCD03E88_SPLIT_BOOT444.
+Gammel ubrukt splitplan789133a6/BOOT443 er erstattet, ikke start den.
+Grenser5793 så5809; ingen full epoch eller VAL. Source/recipe uendret ved
+boot-binding. Bevar referencecheckpointet og start ikke reference på nytt.
+
+Etter to splitPASS: sammenlign faktiske tilstander med reference96, inklusive
+modell/frossen lærer/optimizer/EMA/RNG/sampler/progress; bare checkpointindex og
+sessionidentitet forventes å være forskjellige. Gjenbruk eksisterende
+verify_candidate_checkpoint_resume-eier og tidligere sammenligningsoperator.
+Ny læringskvalitet og ny VAL256-paritet er ennå ikke målt. Ingen automatisk
+full epoch, ny lærer/EMA, replay eller spekulative endringer.
+
+Bevis:REFERENCE32_OBSERVATION_20260916.json under localhandover_snapshot/
+NATIVE_FROZEN_TRACE_MEMORY_FCD03E88_REFERENCE; FRESH_BOOT_REBIND_444.json og
+WINDOWS_ACTIVATION_BOOT444.json under tilsvarende SPLIT-mappe. Lokal status:
+FROZEN_TRACE_REFERENCE_PASS_SPLIT_START_20260916.json. Ingen source-commit
+mens splitkjøringen bruker frossetHEAD; samle terminale bevis i neste commit.
+
+## Ny reference32 starter med minnerettelsen fcd03e88 — 2026-09-16
+
+Lokal driftsoppdatering: pushed/clean fcd03e884c2b402979624df767a359c57562c2e1
+er frosset.48 målrettede tester, faktisk cachet CPU-paritet og commit-vakter
+består. Ny reference32 er startbestilt i Windows-task, Running/Enabled.
+ControllerinspectPID23168 var levende; GPU/treningssteg er ennå ikke bekreftet.
+Forberedt påboot443; controller krever neste fysiske boot før GPU-start.
+
+Reference:NATIVE_FROZEN_TRACE_MEMORY_FCD03E88_REFERENCE, planSHA
+44cd373bdc19c0c862cc3487940e4d9141c990a0251501809030779fae8055b4,
+runtime /home/andre2/GX1_RUNS/NATIVE_FROZEN_TRACE_MEMORY_FCD03E88_REFERENCE_BOOT443.
+Etter referencePASS følger forberedt SPLIT16+16 påsammefrosnekilde:
+planSHA789133a6cfb9967c8a0a3e30560317f07bab5ca1400bb31180d2202399cde1a8,
+runtime /home/andre2/GX1_RUNS/NATIVE_FROZEN_TRACE_MEMORY_FCD03E88_SPLIT_BOOT443.
+Absolutte steggrenser5809 og5793/5809 fra original95/global5777.
+Gjenbruk faktisk15-felts native95-overføring: bare target-batching-eieren er
+endret, source-/session-/overgangseiere uendret. Forberedelsen tok200.16s uten
+ny checkpoint-replay. Originale95/134 og OOM-forsøket0f0a3542 er bevart.
+
+Kontroller faktisk oppstart/resultat og ikke endre kilden under kjøring. Ingen
+full epoch/VAL eller ny læringspåstand. GPU-minne/paritet/totalfart/resume og
+deretter avgrenset faktisk læring gjenstår. SeFROZEN_TRACE_MEMORY_NATIVE_START_
+20260916.json samt begge NATIVE_FROZEN_TRACE_MEMORY_FCD03E88-mapper under
+handover_snapshot. Operatører/logger/Windows-taskbackup er bevart i remote
+runmapper. Denne lokale driftsoppdateringen innarbeides ved neste terminale
+commit; ikke endre aktivsourcefor dokumentasjon.
+
