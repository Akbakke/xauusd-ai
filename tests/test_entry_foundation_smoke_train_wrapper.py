...
def test_smoke_train_dry_run_prints_post_smoke_audit_command() -> None:
    ...
    assert "ENTRY_HIER_CTX_DIRECTION_CALIBRATION_SCALE=0.0" in result.stdout
    assert "ENTRY_HIER_CTX_DIRECTION_CALIBRATION_CAP=0.0" in result.stdout
    ...
    assert "ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN_WEIGHT=0.0" in result.stdout
    assert "ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN=0.10" in result.stdout
    assert "ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN_MIN_LABEL_RATE=0.10" in result.stdout
    assert "ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_WEIGHT=0.0" in result.stdout
    assert "ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN=0.10" in result.stdout
    assert "ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_MIN_LABEL_RATE=0.10" in result.stdout
    assert "ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_MIN_ROWS=8" in result.stdout
...
def test_smart_smoke_dry_run_uses_xau_direction_repair_recipe() -> None:
    ...
    assert "ENTRY_HIER_CTX_DIRECTION_CALIBRATION_SCALE=0.50" in result.stdout
    assert "ENTRY_HIER_CTX_DIRECTION_CALIBRATION_CAP=0.35" in result.stdout
    ...
    assert "ENTRY_HIER_SLICE_PUBLIC_FLAT_CONSISTENCY_MIN_LABEL_RATE=0.10" in result.stdout
    assert "ENTRY_HIER_SLICE_PUBLIC_FLAT_CONSISTENCY_MIN_ROWS=8" in result.stdout
    assert "ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN_WEIGHT=6.00" in result.stdout
    assert "ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN=0.10" in result.stdout
    assert "ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN_MIN_LABEL_RATE=0.10" in result.stdout
    assert "ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_WEIGHT=6.00" in result.stdout
    assert "ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN=0.10" in result.stdout
    assert "ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_MIN_LABEL_RATE=0.10" in result.stdout
    assert "ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_MIN_ROWS=8" in result.stdout
...
def test_smoke_train_wrapper_enforces_train_readiness_for_real_train() -> None:
    ...
    assert "ENTRY_FOUNDATION_SMOKE_HIER_CTX_DIRECTION_CALIBRATION_SCALE" in text
    assert "ENTRY_FOUNDATION_SMOKE_HIER_CTX_DIRECTION_CALIBRATION_CAP" in text
    ...
    assert (
        'ENTRY_HIER_CTX_DIRECTION_CALIBRATION_SCALE="$SMOKE_HIER_CTX_DIRECTION_CALIBRATION_SCALE"'
        in text
    )
    assert 'ENTRY_HIER_CTX_DIRECTION_CALIBRATION_CAP="$SMOKE_HIER_CTX_DIRECTION_CALIBRATION_CAP"' in text
    ...
    assert "SMOKE_HIER_CTX_DIRECTION_CALIBRATION_SCALE=0.50" in text
    assert "SMOKE_HIER_CTX_DIRECTION_CALIBRATION_CAP=0.35" in text
