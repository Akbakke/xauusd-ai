...
def test_v10_6yr_rebuild_uses_smart_seq520_inline_direction_repair_surface() -> None:
    ...
    assert (
        ...
        "${ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN_WEIGHT:-6.00}" in text
    )
    assert "ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN=${ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN:-0.10}" in text
    assert (
        "ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN_MIN_LABEL_RATE="
        "${ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN_MIN_LABEL_RATE:-0.10}" in text
    )
    assert (
        "ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_WEIGHT="
        "${ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_WEIGHT:-6.00}" in text
    )
    assert (
        "ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN="
        "${ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN:-0.10}" in text
    )
    assert (
        "ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_MIN_LABEL_RATE="
        "${ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_MIN_LABEL_RATE:-0.10}" in text
    )
    assert (
        "ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_MIN_ROWS="
        "${ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_MIN_ROWS:-8}" in text
    )
    assert (
    ...
    assert "ENTRY_HIER_PUBLIC_FLAT_HEAD=${ENTRY_HIER_PUBLIC_FLAT_HEAD:-1}" in text
    assert (
    ...
    assert (
        ...
        "${ENTRY_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE:-1}" in text
    )
    assert (
        "ENTRY_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE_SCALE="
        "${ENTRY_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE_SCALE:-0.50}" in text
    )
    assert (
        "ENTRY_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE_CAP="
        "${ENTRY_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE_CAP:-0.25}" in text
    )
    assert (
        "ENTRY_HIER_PUBLIC_SIDE_HEAD_RESIDUAL_CAP_WEIGHT="
        "${ENTRY_HIER_PUBLIC_SIDE_HEAD_RESIDUAL_CAP_WEIGHT:-8.00}" in text
    )
    assert (
        "ENTRY_HIER_PUBLIC_SIDE_HEAD_RESIDUAL_CAP="
        "${ENTRY_HIER_PUBLIC_SIDE_HEAD_RESIDUAL_CAP:-0.20}" in text
    )
