...
TRAIN_ENABLEMENT_JSON=/tmp/ENTRY_EXIT_TRANSFORMER_TRAIN_ENABLEMENT_latest.json
TRAIN_ENABLEMENT_READY=ENTRY_EXIT_TRANSFORMER_TRAIN_ENABLEMENT_READY_FOR_EXPLICIT_EXECUTION
TRAIN_ENABLEMENT_PACKAGE_ALLOW=exit_training_allowed_with_this_package
TRAIN_ENABLEMENT_VEDTAK_IDENTITY="train enablement vedtak does not match wrapper vedtak"
TRAIN_ENABLEMENT_OUTPUT_IDENTITY="train enablement out_bundle_dir does not match wrapper output"
NUM_WORKERS=0
{disabled_flag}
