...
def _entry_fitted_q_iteration() -> dict[str, object]:
    ...
    return {
        "schema_version": "gx1_entry_fitted_q_iteration_state_v1",
        "iteration_index": 4,
...
def test_supervision_binds_entry_and_exit_frozen_fitted_q_iterations(
    ...
    assert entry_supervision["schema_version"] == "gx1_entry_fitted_q_v1"
    assert exit_supervision["schema_version"] == "gx1_unified_exit_fitted_q_v1"
