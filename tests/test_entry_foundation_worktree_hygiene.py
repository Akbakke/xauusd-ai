...
def test_worktree_hygiene_classifies_foundation_and_review_paths() -> None:
    ...
    assert classify_path("gx1/scripts/materialize_entry_exit_per_bar_handoff_v1.py") == "active_foundation_contract"
...
def test_worktree_hygiene_current_repo_report(tmp_path: Path) -> None:
    ...
    assert "gx1/scripts/materialize_entry_exit_per_bar_handoff_v1.py" in FOUNDATION_CLEANUP_CRITICAL_GATE_PATHS
    ...
    assert "tests/test_entry_exit_per_bar_handoff.py" in FOUNDATION_CLEANUP_CRITICAL_GATE_PATHS
    ...
    assert "gx1/scripts/materialize_entry_exit_per_bar_handoff_v1.py" in FOUNDATION_CLEANUP_REQUIRED_PATHS
    ...
    assert "tests/test_entry_exit_per_bar_handoff.py" in FOUNDATION_CLEANUP_REQUIRED_PATHS
