...
def test_foundation_guardrails_current_repo_lock_control_and_handover(tmp_path: Path) -> None:
    ...
    assert policy_checks["readiness_policy_safe_now_challenger_extension_manifest"] is True
    assert policy_checks["readiness_policy_safe_now_challenger_smart_extension_manifest"] is True
    ...
    assert policy_checks["readiness_policy_safe_now_entry_exit_feature_alignment"] is True
    assert policy_checks["readiness_policy_safe_now_entry_exit_feature_alignment_smart_selected"] is True
    ...
    assert policy_checks["readiness_policy_safe_now_entry_exit_transformer_train_execution_review"] is True
    assert policy_checks["readiness_policy_safe_now_entry_exit_transformer_post_train_contract"] is True
