...
def _current_work_status(repo: Path, *, source_only: bool) -> dict | None:
    ...
    result = {
        ...
        "latest_completed_diagnostic": record.get("completed_main_encoder_representation") or record.get("completed_residual_representation") or record.get("completed_entry_signal_inference_check") or record.get("completed_entry_forward_parity"),
