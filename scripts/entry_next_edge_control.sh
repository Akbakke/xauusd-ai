...
if entry_exit_transformer_train_execution_review_ready:
...
commands.update(
    {
        ...
        "entry_exit_transformer_train": {
            ...
            "starts_iql_distillation": False,
            "touches_shadow_or_live": False,
            "description": "Blocked active Exit Transformer trainer path; trainer core/pretrain-manifest gate is not approved.",
        },
        "preview_shadow": {
...
not_executable_now_reason = {
    ...
    "entry_exit_transformer_train": "requires active Exit Transformer trainer core, pretrain-manifest audit, clean git and explicit Exit train vedtak",
