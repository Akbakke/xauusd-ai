...
CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_WEIGHT="${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_WEIGHT:-0.0}"
CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_MIN_GAP_BPS="${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_MIN_GAP_BPS:-15.0}"
CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_MIN_UTILITY_BPS="${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_MIN_UTILITY_BPS:-0.0}"
CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_MAX_BAD_PATH="${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_MAX_BAD_PATH:-0.50}"
CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_CLASS_WEIGHT_CAP="${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_CLASS_WEIGHT_CAP:-4.0}"
CANDIDATE_DIRECTION_HIERARCHICAL_COMPOSITION="${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_HIERARCHICAL_COMPOSITION:-0}"
CANDIDATE_HIER_COMPOSE_RESIDUAL_LOGIT_CAP="${ENTRY_FOUNDATION_CANDIDATE_HIER_COMPOSE_RESIDUAL_LOGIT_CAP:-0.0}"
CANDIDATE_HIER_COMPOSE_RESIDUAL_SIDE_NEUTRAL="${ENTRY_FOUNDATION_CANDIDATE_HIER_COMPOSE_RESIDUAL_SIDE_NEUTRAL:-0}"
CANDIDATE_HIER_COMPOSE_PUBLIC_FLAT_FROM_TRADE="${ENTRY_FOUNDATION_CANDIDATE_HIER_COMPOSE_PUBLIC_FLAT_FROM_TRADE:-0}"
CANDIDATE_HIER_PUBLIC_DIRECTION_COMPOSITION="${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_DIRECTION_COMPOSITION:-logprob}"
CANDIDATE_HIER_PUBLIC_DIRECTION_DETACH_SIDE_GRAD="${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_DIRECTION_DETACH_SIDE_GRAD:-0}"
CANDIDATE_HIER_PUBLIC_TRADE_HEAD="${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_TRADE_HEAD:-0}"
CANDIDATE_HIER_PUBLIC_FLAT_HEAD="${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_FLAT_HEAD:-0}"
CANDIDATE_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE="${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE:-0}"
CANDIDATE_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE_SCALE="${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE_SCALE:-0.0}"
CANDIDATE_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE_CAP="${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE_CAP:-0.0}"
CANDIDATE_HIER_PUBLIC_SIDE_HEAD="${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_SIDE_HEAD:-0}"
CANDIDATE_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE="${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE:-0}"
CANDIDATE_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE_SCALE="${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE_SCALE:-0.0}"
CANDIDATE_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE_CAP="${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE_CAP:-0.0}"
CANDIDATE_HIER_PUBLIC_SIDE_HEAD_RESIDUAL_CAP_WEIGHT="${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_SIDE_HEAD_RESIDUAL_CAP_WEIGHT:-0.0}"
CANDIDATE_HIER_PUBLIC_SIDE_HEAD_RESIDUAL_CAP="${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_SIDE_HEAD_RESIDUAL_CAP:-0.0}"
CANDIDATE_HIER_CTX_PRIOR_ADAPTER="${ENTRY_FOUNDATION_CANDIDATE_HIER_CTX_PRIOR_ADAPTER:-0}"
CANDIDATE_HIER_CTX_PRIOR_ADAPTER_SCALE="${ENTRY_FOUNDATION_CANDIDATE_HIER_CTX_PRIOR_ADAPTER_SCALE:-0.0}"
CANDIDATE_HIER_CTX_DIRECTION_CALIBRATION="${ENTRY_FOUNDATION_CANDIDATE_HIER_CTX_DIRECTION_CALIBRATION:-0}"
CANDIDATE_HIER_CTX_DIRECTION_CALIBRATION_SCALE="${ENTRY_FOUNDATION_CANDIDATE_HIER_CTX_DIRECTION_CALIBRATION_SCALE:-0.0}"
CANDIDATE_HIER_CTX_DIRECTION_CALIBRATION_CAP="${ENTRY_FOUNDATION_CANDIDATE_HIER_CTX_DIRECTION_CALIBRATION_CAP:-0.0}"
...
CANDIDATE_HIER_TRADE_GLOBAL_PRIOR_MATCH_WEIGHT="${ENTRY_FOUNDATION_CANDIDATE_HIER_TRADE_GLOBAL_PRIOR_MATCH_WEIGHT:-0.0}"
CANDIDATE_HIER_TRADE_GLOBAL_PRIOR_MATCH_TOLERANCE="${ENTRY_FOUNDATION_CANDIDATE_HIER_TRADE_GLOBAL_PRIOR_MATCH_TOLERANCE:-0.02}"
CANDIDATE_HIER_TRADE_GLOBAL_PRIOR_MATCH_MIN_LABEL_RATE="${ENTRY_FOUNDATION_CANDIDATE_HIER_TRADE_GLOBAL_PRIOR_MATCH_MIN_LABEL_RATE:-0.10}"
CANDIDATE_HIER_SLICE_TRADE_PRIOR_MATCH_WEIGHT="${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_TRADE_PRIOR_MATCH_WEIGHT:-0.0}"
CANDIDATE_HIER_SLICE_TRADE_PRIOR_MATCH_TOLERANCE="${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_TRADE_PRIOR_MATCH_TOLERANCE:-0.02}"
CANDIDATE_HIER_SLICE_TRADE_PRIOR_MATCH_MIN_LABEL_RATE="${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_TRADE_PRIOR_MATCH_MIN_LABEL_RATE:-0.10}"
CANDIDATE_HIER_SLICE_TRADE_PRIOR_MATCH_MIN_ROWS="${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_TRADE_PRIOR_MATCH_MIN_ROWS:-8}"
CANDIDATE_HIER_SLICE_TRADE_ACCURACY_EDGE_WEIGHT="${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_TRADE_ACCURACY_EDGE_WEIGHT:-0.0}"
CANDIDATE_HIER_SLICE_TRADE_ACCURACY_EDGE_MARGIN="${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_TRADE_ACCURACY_EDGE_MARGIN:-0.02}"
...
CANDIDATE_HIER_SLICE_SIDE_CE_WEIGHT="${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_SIDE_CE_WEIGHT:-0.0}"
CANDIDATE_HIER_SLICE_SIDE_TRUE_MARGIN_WEIGHT="${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_SIDE_TRUE_MARGIN_WEIGHT:-0.0}"
CANDIDATE_HIER_SLICE_SIDE_TRUE_MARGIN="${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_SIDE_TRUE_MARGIN:-0.10}"
CANDIDATE_HIER_SLICE_SIDE_ACCURACY_EDGE_WEIGHT="${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_SIDE_ACCURACY_EDGE_WEIGHT:-0.0}"
CANDIDATE_HIER_SLICE_SIDE_ACCURACY_EDGE_MARGIN="${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_SIDE_ACCURACY_EDGE_MARGIN:-0.02}"
CANDIDATE_HIER_SLICE_SIDE_MIN_LABEL_RATE="${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_SIDE_MIN_LABEL_RATE:-0.10}"
CANDIDATE_HIER_SLICE_SIDE_MIN_ROWS="${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_SIDE_MIN_ROWS:-8}"
CANDIDATE_HIER_SIDE_GLOBAL_PRIOR_MATCH_WEIGHT="${ENTRY_FOUNDATION_CANDIDATE_HIER_SIDE_GLOBAL_PRIOR_MATCH_WEIGHT:-0.0}"
CANDIDATE_HIER_SIDE_GLOBAL_PRIOR_MATCH_TOLERANCE="${ENTRY_FOUNDATION_CANDIDATE_HIER_SIDE_GLOBAL_PRIOR_MATCH_TOLERANCE:-0.02}"
CANDIDATE_HIER_SIDE_GLOBAL_PRIOR_MATCH_MIN_LABEL_RATE="${ENTRY_FOUNDATION_CANDIDATE_HIER_SIDE_GLOBAL_PRIOR_MATCH_MIN_LABEL_RATE:-0.10}"
CANDIDATE_HIER_SLICE_SIDE_PRIOR_MATCH_WEIGHT="${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_SIDE_PRIOR_MATCH_WEIGHT:-0.0}"
CANDIDATE_HIER_SLICE_SIDE_PRIOR_MATCH_TOLERANCE="${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_SIDE_PRIOR_MATCH_TOLERANCE:-0.02}"
CANDIDATE_HIER_SLICE_SIDE_PRIOR_MATCH_MIN_LABEL_RATE="${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_SIDE_PRIOR_MATCH_MIN_LABEL_RATE:-0.10}"
CANDIDATE_HIER_SLICE_SIDE_PRIOR_MATCH_MIN_ROWS="${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_SIDE_PRIOR_MATCH_MIN_ROWS:-8}"
...
CANDIDATE_RESIDUAL_SCALE="${ENTRY_FOUNDATION_CANDIDATE_RESIDUAL_SCALE:-0.35}"
CANDIDATE_ANCHOR_EPS="${ENTRY_FOUNDATION_CANDIDATE_ANCHOR_EPS:-1e-6}"
...
Candidate edge recipe env:
  ...
  ENTRY_FOUNDATION_CANDIDATE_CKPT_DIRECTION_SLICE_GUARD Default: 0
  ...
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_GLOBAL_PRIOR_MATCH_WEIGHT Default: 0.0
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_GLOBAL_PRIOR_MATCH_TOLERANCE Default: 0.02
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_GLOBAL_PRIOR_MATCH_MIN_LABEL_RATE Default: 0.10
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_BALANCED_CE_WEIGHT Default: 0.0
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_BALANCED_CE_MIN_LABEL_RATE Default: 0.10
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_BALANCED_CE_MIN_ROWS Default: 8
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_TRUE_MARGIN_WEIGHT Default: 0.0
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_TRUE_MARGIN Default: 0.10
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_TRUE_MARGIN_MIN_LABEL_RATE Default: 0.10
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_TRUE_MARGIN_MIN_ROWS Default: 8
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_ACCURACY_EDGE_WEIGHT Default: 0.0
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_ACCURACY_EDGE_MARGIN Default: 0.02
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_CONFUSION_PAIR_WEIGHT Default: 0.0
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_CONFUSION_PAIR_MARGIN Default: 0.02
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_ACCURACY_EDGE_MIN_LABEL_RATE Default: 0.10
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_ACCURACY_EDGE_MIN_ROWS Default: 8
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_PRIOR_MATCH_WEIGHT Default: 0.0
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_PRIOR_MATCH_TOLERANCE Default: 0.02
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_PRIOR_MATCH_MIN_LABEL_RATE Default: 0.10
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_PRIOR_MATCH_MIN_ROWS Default: 8
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_HARD_RED_STOP_PATIENCE Default: 0
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_HARD_RED_STOP_MIN_EPOCHS Default: 6
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_BALANCED_SAMPLER Default: 0
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_BALANCED_SAMPLER_MIN_ROWS Default: 8
  ...
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_MARGIN_WEIGHT Default: 0.0
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_MIN_GAP_BPS Default: 15.0
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_LOGIT_MARGIN Default: 0.10
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SIDE_UTILITY_CONVICTION_WEIGHT Default: 0.0
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SIDE_UTILITY_CONVICTION_MIN_GAP_BPS Default: 15.0
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SIDE_UTILITY_CONVICTION_LOGIT_MARGIN Default: 0.10
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_TRADE_CONVICTION_WEIGHT Default: 0.0
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_TRADE_CONVICTION_MIN_GAP_BPS Default: 15.0
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_TRADE_CONVICTION_MIN_UTILITY_BPS Default: 0.0
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_TRADE_CONVICTION_MAX_BAD_PATH Default: 0.50
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_TRADE_CONVICTION_LOGIT_MARGIN Default: 0.10
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_FLAT_STARVATION_WEIGHT Default: 0.0
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_FLAT_STARVATION_MIN_LABEL_RATE Default: 0.10
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_FLAT_STARVATION_MIN_ROWS Default: 8
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_FLAT_STARVATION_PRED_FRACTION Default: 0.50
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_FLAT_STARVATION_PRED_FLOOR Default: 0.10
  ENTRY_FOUNDATION_CANDIDATE_DIRECTION_FLAT_STARVATION_LOGIT_MARGIN Default: 0.10
  ...
  ENTRY_FOUNDATION_CANDIDATE_RESIDUAL_SCALE                  Default: 0.35
  ENTRY_FOUNDATION_CANDIDATE_HIER_COMPOSE_RESIDUAL_LOGIT_CAP Default: 0.0
  ENTRY_FOUNDATION_CANDIDATE_HIER_COMPOSE_RESIDUAL_SIDE_NEUTRAL Default: 0
  ENTRY_FOUNDATION_CANDIDATE_HIER_COMPOSE_PUBLIC_FLAT_FROM_TRADE Default: 0
  ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_DIRECTION_COMPOSITION Default: logprob
  ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_DIRECTION_DETACH_SIDE_GRAD Default: 0
  ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_TRADE_HEAD Default: 0
  ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_FLAT_HEAD Default: 0
  ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE Default: 0
  ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE_SCALE Default: 0.0
  ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE_CAP Default: 0.0
  ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_SIDE_HEAD Default: 0
  ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE Default: 0
  ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE_SCALE Default: 0.0
  ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE_CAP Default: 0.0
  ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_SIDE_HEAD_RESIDUAL_CAP_WEIGHT Default: 0.0
  ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_SIDE_HEAD_RESIDUAL_CAP Default: 0.0
  ENTRY_FOUNDATION_CANDIDATE_HIER_CTX_PRIOR_ADAPTER Default: 0
  ENTRY_FOUNDATION_CANDIDATE_HIER_CTX_PRIOR_ADAPTER_SCALE Default: 0.0
  ENTRY_FOUNDATION_CANDIDATE_HIER_CTX_DIRECTION_CALIBRATION Default: 0
  ENTRY_FOUNDATION_CANDIDATE_HIER_CTX_DIRECTION_CALIBRATION_SCALE Default: 0.0
  ENTRY_FOUNDATION_CANDIDATE_HIER_CTX_DIRECTION_CALIBRATION_CAP Default: 0.0
  ENTRY_FOUNDATION_CANDIDATE_ANCHOR_EPS                      Default: 1e-6
...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    --smart-seq520)
      ...
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_CKPT_DIRECTION_SLICE_GUARD+x}" ]]; then
        CANDIDATE_CKPT_DIRECTION_SLICE_GUARD=1
      fi
      ...
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_MIN_PRED_RATE_SOFTMAX_TEMPERATURE+x}" ]]; then
        CANDIDATE_DIRECTION_MIN_PRED_RATE_SOFTMAX_TEMPERATURE=0.05
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_GLOBAL_PRIOR_MATCH_WEIGHT+x}" ]]; then
        CANDIDATE_DIRECTION_GLOBAL_PRIOR_MATCH_WEIGHT=8.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_GLOBAL_PRIOR_MATCH_TOLERANCE+x}" ]]; then
        CANDIDATE_DIRECTION_GLOBAL_PRIOR_MATCH_TOLERANCE=0.02
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_GLOBAL_PRIOR_MATCH_MIN_LABEL_RATE+x}" ]]; then
        CANDIDATE_DIRECTION_GLOBAL_PRIOR_MATCH_MIN_LABEL_RATE=0.10
      fi
      ...
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_BALANCED_CE_WEIGHT+x}" ]]; then
        CANDIDATE_DIRECTION_SLICE_BALANCED_CE_WEIGHT=2.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_BALANCED_CE_MIN_LABEL_RATE+x}" ]]; then
        CANDIDATE_DIRECTION_SLICE_BALANCED_CE_MIN_LABEL_RATE=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_BALANCED_CE_MIN_ROWS+x}" ]]; then
        CANDIDATE_DIRECTION_SLICE_BALANCED_CE_MIN_ROWS=8
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_TRUE_MARGIN_WEIGHT+x}" ]]; then
        CANDIDATE_DIRECTION_SLICE_TRUE_MARGIN_WEIGHT=2.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_TRUE_MARGIN+x}" ]]; then
        CANDIDATE_DIRECTION_SLICE_TRUE_MARGIN=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_TRUE_MARGIN_MIN_LABEL_RATE+x}" ]]; then
        CANDIDATE_DIRECTION_SLICE_TRUE_MARGIN_MIN_LABEL_RATE=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_TRUE_MARGIN_MIN_ROWS+x}" ]]; then
        CANDIDATE_DIRECTION_SLICE_TRUE_MARGIN_MIN_ROWS=8
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_ACCURACY_EDGE_WEIGHT+x}" ]]; then
        CANDIDATE_DIRECTION_SLICE_ACCURACY_EDGE_WEIGHT=4.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_ACCURACY_EDGE_MARGIN+x}" ]]; then
        CANDIDATE_DIRECTION_SLICE_ACCURACY_EDGE_MARGIN=0.02
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_CONFUSION_PAIR_WEIGHT+x}" ]]; then
        CANDIDATE_DIRECTION_SLICE_CONFUSION_PAIR_WEIGHT=4.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_CONFUSION_PAIR_MARGIN+x}" ]]; then
        CANDIDATE_DIRECTION_SLICE_CONFUSION_PAIR_MARGIN=0.02
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_ACCURACY_EDGE_MIN_LABEL_RATE+x}" ]]; then
        CANDIDATE_DIRECTION_SLICE_ACCURACY_EDGE_MIN_LABEL_RATE=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_ACCURACY_EDGE_MIN_ROWS+x}" ]]; then
        CANDIDATE_DIRECTION_SLICE_ACCURACY_EDGE_MIN_ROWS=8
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_PRIOR_MATCH_WEIGHT+x}" ]]; then
        CANDIDATE_DIRECTION_SLICE_PRIOR_MATCH_WEIGHT=3.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_PRIOR_MATCH_TOLERANCE+x}" ]]; then
        CANDIDATE_DIRECTION_SLICE_PRIOR_MATCH_TOLERANCE=0.02
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_PRIOR_MATCH_MIN_LABEL_RATE+x}" ]]; then
        CANDIDATE_DIRECTION_SLICE_PRIOR_MATCH_MIN_LABEL_RATE=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_PRIOR_MATCH_MIN_ROWS+x}" ]]; then
        CANDIDATE_DIRECTION_SLICE_PRIOR_MATCH_MIN_ROWS=8
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_LOSS_AGGREGATION+x}" ]]; then
        CANDIDATE_DIRECTION_SLICE_LOSS_AGGREGATION=mean_max
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_BALANCED_SAMPLER+x}" ]]; then
        CANDIDATE_DIRECTION_SLICE_BALANCED_SAMPLER=1
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_BALANCED_SAMPLER_MIN_ROWS+x}" ]]; then
        CANDIDATE_DIRECTION_SLICE_BALANCED_SAMPLER_MIN_ROWS=8
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_HARD_RED_STOP_PATIENCE+x}" ]]; then
        CANDIDATE_DIRECTION_SLICE_HARD_RED_STOP_PATIENCE=3
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SLICE_HARD_RED_STOP_MIN_EPOCHS+x}" ]]; then
        CANDIDATE_DIRECTION_SLICE_HARD_RED_STOP_MIN_EPOCHS=6
      fi
      ...
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_MARGIN_WEIGHT+x}" ]]; then
        CANDIDATE_DIRECTION_UTILITY_MARGIN_WEIGHT=4.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_MIN_GAP_BPS+x}" ]]; then
        CANDIDATE_DIRECTION_UTILITY_MIN_GAP_BPS=15.0
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_LOGIT_MARGIN+x}" ]]; then
        CANDIDATE_DIRECTION_UTILITY_LOGIT_MARGIN=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SIDE_UTILITY_CONVICTION_WEIGHT+x}" ]]; then
        CANDIDATE_DIRECTION_SIDE_UTILITY_CONVICTION_WEIGHT=6.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SIDE_UTILITY_CONVICTION_MIN_GAP_BPS+x}" ]]; then
        CANDIDATE_DIRECTION_SIDE_UTILITY_CONVICTION_MIN_GAP_BPS=15.0
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_SIDE_UTILITY_CONVICTION_LOGIT_MARGIN+x}" ]]; then
        CANDIDATE_DIRECTION_SIDE_UTILITY_CONVICTION_LOGIT_MARGIN=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_TRADE_CONVICTION_WEIGHT+x}" ]]; then
        CANDIDATE_DIRECTION_UTILITY_TRADE_CONVICTION_WEIGHT=8.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_TRADE_CONVICTION_MIN_GAP_BPS+x}" ]]; then
        CANDIDATE_DIRECTION_UTILITY_TRADE_CONVICTION_MIN_GAP_BPS=15.0
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_TRADE_CONVICTION_MIN_UTILITY_BPS+x}" ]]; then
        CANDIDATE_DIRECTION_UTILITY_TRADE_CONVICTION_MIN_UTILITY_BPS=0.0
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_TRADE_CONVICTION_MAX_BAD_PATH+x}" ]]; then
        CANDIDATE_DIRECTION_UTILITY_TRADE_CONVICTION_MAX_BAD_PATH=0.50
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_TRADE_CONVICTION_LOGIT_MARGIN+x}" ]]; then
        CANDIDATE_DIRECTION_UTILITY_TRADE_CONVICTION_LOGIT_MARGIN=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_WEIGHT+x}" ]]; then
        CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_WEIGHT=8.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_MIN_GAP_BPS+x}" ]]; then
        CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_MIN_GAP_BPS=15.0
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_MIN_UTILITY_BPS+x}" ]]; then
        CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_MIN_UTILITY_BPS=0.0
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_MAX_BAD_PATH+x}" ]]; then
        CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_MAX_BAD_PATH=0.50
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_CLASS_WEIGHT_CAP+x}" ]]; then
        CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_CLASS_WEIGHT_CAP=4.0
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_HIERARCHICAL_COMPOSITION+x}" ]]; then
        CANDIDATE_DIRECTION_HIERARCHICAL_COMPOSITION=1
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_COMPOSE_RESIDUAL_LOGIT_CAP+x}" ]]; then
        CANDIDATE_HIER_COMPOSE_RESIDUAL_LOGIT_CAP=0.18
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_COMPOSE_RESIDUAL_SIDE_NEUTRAL+x}" ]]; then
        CANDIDATE_HIER_COMPOSE_RESIDUAL_SIDE_NEUTRAL=1
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_COMPOSE_PUBLIC_FLAT_FROM_TRADE+x}" ]]; then
        CANDIDATE_HIER_COMPOSE_PUBLIC_FLAT_FROM_TRADE=1
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_DIRECTION_COMPOSITION+x}" ]]; then
        CANDIDATE_HIER_PUBLIC_DIRECTION_COMPOSITION=margin_maxnorm_confidence
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_DIRECTION_DETACH_SIDE_GRAD+x}" ]]; then
        CANDIDATE_HIER_PUBLIC_DIRECTION_DETACH_SIDE_GRAD=1
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_TRADE_HEAD+x}" ]]; then
        CANDIDATE_HIER_PUBLIC_TRADE_HEAD=1
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_FLAT_HEAD+x}" ]]; then
        CANDIDATE_HIER_PUBLIC_FLAT_HEAD=1
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE+x}" ]]; then
        CANDIDATE_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE=1
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE_SCALE+x}" ]]; then
        CANDIDATE_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE_SCALE=0.50
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE_CAP+x}" ]]; then
        CANDIDATE_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE_CAP=0.25
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_SIDE_HEAD+x}" ]]; then
        CANDIDATE_HIER_PUBLIC_SIDE_HEAD=1
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE+x}" ]]; then
        CANDIDATE_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE=1
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE_SCALE+x}" ]]; then
        CANDIDATE_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE_SCALE=0.50
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE_CAP+x}" ]]; then
        CANDIDATE_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE_CAP=0.25
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_SIDE_HEAD_RESIDUAL_CAP_WEIGHT+x}" ]]; then
        CANDIDATE_HIER_PUBLIC_SIDE_HEAD_RESIDUAL_CAP_WEIGHT=8.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_SIDE_HEAD_RESIDUAL_CAP+x}" ]]; then
        CANDIDATE_HIER_PUBLIC_SIDE_HEAD_RESIDUAL_CAP=0.20
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_CTX_PRIOR_ADAPTER+x}" ]]; then
        CANDIDATE_HIER_CTX_PRIOR_ADAPTER=1
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_CTX_PRIOR_ADAPTER_SCALE+x}" ]]; then
        CANDIDATE_HIER_CTX_PRIOR_ADAPTER_SCALE=0.50
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_CTX_DIRECTION_CALIBRATION+x}" ]]; then
        CANDIDATE_HIER_CTX_DIRECTION_CALIBRATION=1
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_CTX_DIRECTION_CALIBRATION_SCALE+x}" ]]; then
        CANDIDATE_HIER_CTX_DIRECTION_CALIBRATION_SCALE=0.50
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_CTX_DIRECTION_CALIBRATION_CAP+x}" ]]; then
        CANDIDATE_HIER_CTX_DIRECTION_CALIBRATION_CAP=0.35
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_FLAT_STARVATION_WEIGHT+x}" ]]; then
        CANDIDATE_DIRECTION_FLAT_STARVATION_WEIGHT=8.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_FLAT_STARVATION_MIN_LABEL_RATE+x}" ]]; then
        CANDIDATE_DIRECTION_FLAT_STARVATION_MIN_LABEL_RATE=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_FLAT_STARVATION_MIN_ROWS+x}" ]]; then
        CANDIDATE_DIRECTION_FLAT_STARVATION_MIN_ROWS=8
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_FLAT_STARVATION_PRED_FRACTION+x}" ]]; then
        CANDIDATE_DIRECTION_FLAT_STARVATION_PRED_FRACTION=0.50
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_FLAT_STARVATION_PRED_FLOOR+x}" ]]; then
        CANDIDATE_DIRECTION_FLAT_STARVATION_PRED_FLOOR=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_DIRECTION_FLAT_STARVATION_LOGIT_MARGIN+x}" ]]; then
        CANDIDATE_DIRECTION_FLAT_STARVATION_LOGIT_MARGIN=0.10
      fi
      ...
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_TRADE_GLOBAL_PRIOR_MATCH_WEIGHT+x}" ]]; then
        CANDIDATE_HIER_TRADE_GLOBAL_PRIOR_MATCH_WEIGHT=4.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_TRADE_GLOBAL_PRIOR_MATCH_TOLERANCE+x}" ]]; then
        CANDIDATE_HIER_TRADE_GLOBAL_PRIOR_MATCH_TOLERANCE=0.02
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_TRADE_GLOBAL_PRIOR_MATCH_MIN_LABEL_RATE+x}" ]]; then
        CANDIDATE_HIER_TRADE_GLOBAL_PRIOR_MATCH_MIN_LABEL_RATE=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_TRADE_PRIOR_MATCH_WEIGHT+x}" ]]; then
        CANDIDATE_HIER_SLICE_TRADE_PRIOR_MATCH_WEIGHT=4.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_TRADE_PRIOR_MATCH_TOLERANCE+x}" ]]; then
        CANDIDATE_HIER_SLICE_TRADE_PRIOR_MATCH_TOLERANCE=0.02
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_TRADE_PRIOR_MATCH_MIN_LABEL_RATE+x}" ]]; then
        CANDIDATE_HIER_SLICE_TRADE_PRIOR_MATCH_MIN_LABEL_RATE=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_TRADE_PRIOR_MATCH_MIN_ROWS+x}" ]]; then
        CANDIDATE_HIER_SLICE_TRADE_PRIOR_MATCH_MIN_ROWS=8
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_TRADE_ACCURACY_EDGE_WEIGHT+x}" ]]; then
        CANDIDATE_HIER_SLICE_TRADE_ACCURACY_EDGE_WEIGHT=4.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_TRADE_ACCURACY_EDGE_MARGIN+x}" ]]; then
        CANDIDATE_HIER_SLICE_TRADE_ACCURACY_EDGE_MARGIN=0.02
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_FLAT_LOGIT_MARGIN_WEIGHT+x}" ]]; then
        CANDIDATE_HIER_FLAT_LOGIT_MARGIN_WEIGHT=8.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_FLAT_LOGIT_MARGIN+x}" ]]; then
        CANDIDATE_HIER_FLAT_LOGIT_MARGIN=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_FLAT_LOGIT_MARGIN_MIN_LABEL_RATE+x}" ]]; then
        CANDIDATE_HIER_FLAT_LOGIT_MARGIN_MIN_LABEL_RATE=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_FLAT_LOGIT_MARGIN_WEIGHT+x}" ]]; then
        CANDIDATE_HIER_SLICE_FLAT_LOGIT_MARGIN_WEIGHT=8.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_FLAT_LOGIT_MARGIN+x}" ]]; then
        CANDIDATE_HIER_SLICE_FLAT_LOGIT_MARGIN=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_FLAT_LOGIT_MARGIN_MIN_LABEL_RATE+x}" ]]; then
        CANDIDATE_HIER_SLICE_FLAT_LOGIT_MARGIN_MIN_LABEL_RATE=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_FLAT_LOGIT_MARGIN_MIN_ROWS+x}" ]]; then
        CANDIDATE_HIER_SLICE_FLAT_LOGIT_MARGIN_MIN_ROWS=8
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_FLAT_CONSISTENCY_WEIGHT+x}" ]]; then
        CANDIDATE_HIER_PUBLIC_FLAT_CONSISTENCY_WEIGHT=4.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_FLAT_CONSISTENCY_MIN_LABEL_RATE+x}" ]]; then
        CANDIDATE_HIER_PUBLIC_FLAT_CONSISTENCY_MIN_LABEL_RATE=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_PUBLIC_FLAT_CONSISTENCY_WEIGHT+x}" ]]; then
        CANDIDATE_HIER_SLICE_PUBLIC_FLAT_CONSISTENCY_WEIGHT=4.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_PUBLIC_FLAT_CONSISTENCY_MIN_LABEL_RATE+x}" ]]; then
        CANDIDATE_HIER_SLICE_PUBLIC_FLAT_CONSISTENCY_MIN_LABEL_RATE=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_PUBLIC_FLAT_CONSISTENCY_MIN_ROWS+x}" ]]; then
        CANDIDATE_HIER_SLICE_PUBLIC_FLAT_CONSISTENCY_MIN_ROWS=8
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_TRADE_FLAT_MARGIN_WEIGHT+x}" ]]; then
        CANDIDATE_HIER_PUBLIC_TRADE_FLAT_MARGIN_WEIGHT=6.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_TRADE_FLAT_MARGIN+x}" ]]; then
        CANDIDATE_HIER_PUBLIC_TRADE_FLAT_MARGIN=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_PUBLIC_TRADE_FLAT_MARGIN_MIN_LABEL_RATE+x}" ]]; then
        CANDIDATE_HIER_PUBLIC_TRADE_FLAT_MARGIN_MIN_LABEL_RATE=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_WEIGHT+x}" ]]; then
        CANDIDATE_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_WEIGHT=6.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN+x}" ]]; then
        CANDIDATE_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_MIN_LABEL_RATE+x}" ]]; then
        CANDIDATE_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_MIN_LABEL_RATE=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_MIN_ROWS+x}" ]]; then
        CANDIDATE_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_MIN_ROWS=8
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_SIDE_CE_WEIGHT+x}" ]]; then
        CANDIDATE_HIER_SLICE_SIDE_CE_WEIGHT=4.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_SIDE_TRUE_MARGIN_WEIGHT+x}" ]]; then
        CANDIDATE_HIER_SLICE_SIDE_TRUE_MARGIN_WEIGHT=3.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_SIDE_TRUE_MARGIN+x}" ]]; then
        CANDIDATE_HIER_SLICE_SIDE_TRUE_MARGIN=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_SIDE_ACCURACY_EDGE_WEIGHT+x}" ]]; then
        CANDIDATE_HIER_SLICE_SIDE_ACCURACY_EDGE_WEIGHT=4.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_SIDE_ACCURACY_EDGE_MARGIN+x}" ]]; then
        CANDIDATE_HIER_SLICE_SIDE_ACCURACY_EDGE_MARGIN=0.02
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_SIDE_MIN_LABEL_RATE+x}" ]]; then
        CANDIDATE_HIER_SLICE_SIDE_MIN_LABEL_RATE=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_SIDE_MIN_ROWS+x}" ]]; then
        CANDIDATE_HIER_SLICE_SIDE_MIN_ROWS=8
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SIDE_GLOBAL_PRIOR_MATCH_WEIGHT+x}" ]]; then
        CANDIDATE_HIER_SIDE_GLOBAL_PRIOR_MATCH_WEIGHT=4.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SIDE_GLOBAL_PRIOR_MATCH_TOLERANCE+x}" ]]; then
        CANDIDATE_HIER_SIDE_GLOBAL_PRIOR_MATCH_TOLERANCE=0.02
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SIDE_GLOBAL_PRIOR_MATCH_MIN_LABEL_RATE+x}" ]]; then
        CANDIDATE_HIER_SIDE_GLOBAL_PRIOR_MATCH_MIN_LABEL_RATE=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_SIDE_PRIOR_MATCH_WEIGHT+x}" ]]; then
        CANDIDATE_HIER_SLICE_SIDE_PRIOR_MATCH_WEIGHT=4.00
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_SIDE_PRIOR_MATCH_TOLERANCE+x}" ]]; then
        CANDIDATE_HIER_SLICE_SIDE_PRIOR_MATCH_TOLERANCE=0.02
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_SIDE_PRIOR_MATCH_MIN_LABEL_RATE+x}" ]]; then
        CANDIDATE_HIER_SLICE_SIDE_PRIOR_MATCH_MIN_LABEL_RATE=0.10
      fi
      if [[ -z "${ENTRY_FOUNDATION_CANDIDATE_HIER_SLICE_SIDE_PRIOR_MATCH_MIN_ROWS+x}" ]]; then
        CANDIDATE_HIER_SLICE_SIDE_PRIOR_MATCH_MIN_ROWS=8
      fi
...
CMD=(
  ...
  ENTRY_CKPT_DIRECTION_SLICE_GUARD="$CANDIDATE_CKPT_DIRECTION_SLICE_GUARD"
  ...
  ENTRY_DIRECTION_GLOBAL_PRIOR_MATCH_WEIGHT="$CANDIDATE_DIRECTION_GLOBAL_PRIOR_MATCH_WEIGHT"
  ENTRY_DIRECTION_GLOBAL_PRIOR_MATCH_TOLERANCE="$CANDIDATE_DIRECTION_GLOBAL_PRIOR_MATCH_TOLERANCE"
  ENTRY_DIRECTION_GLOBAL_PRIOR_MATCH_MIN_LABEL_RATE="$CANDIDATE_DIRECTION_GLOBAL_PRIOR_MATCH_MIN_LABEL_RATE"
  ...
  ENTRY_DIRECTION_SLICE_BALANCED_CE_WEIGHT="$CANDIDATE_DIRECTION_SLICE_BALANCED_CE_WEIGHT"
  ENTRY_DIRECTION_SLICE_BALANCED_CE_MIN_LABEL_RATE="$CANDIDATE_DIRECTION_SLICE_BALANCED_CE_MIN_LABEL_RATE"
  ENTRY_DIRECTION_SLICE_BALANCED_CE_MIN_ROWS="$CANDIDATE_DIRECTION_SLICE_BALANCED_CE_MIN_ROWS"
  ENTRY_DIRECTION_SLICE_TRUE_MARGIN_WEIGHT="$CANDIDATE_DIRECTION_SLICE_TRUE_MARGIN_WEIGHT"
  ENTRY_DIRECTION_SLICE_TRUE_MARGIN="$CANDIDATE_DIRECTION_SLICE_TRUE_MARGIN"
  ENTRY_DIRECTION_SLICE_TRUE_MARGIN_MIN_LABEL_RATE="$CANDIDATE_DIRECTION_SLICE_TRUE_MARGIN_MIN_LABEL_RATE"
  ENTRY_DIRECTION_SLICE_TRUE_MARGIN_MIN_ROWS="$CANDIDATE_DIRECTION_SLICE_TRUE_MARGIN_MIN_ROWS"
  ENTRY_DIRECTION_SLICE_ACCURACY_EDGE_WEIGHT="$CANDIDATE_DIRECTION_SLICE_ACCURACY_EDGE_WEIGHT"
  ENTRY_DIRECTION_SLICE_ACCURACY_EDGE_MARGIN="$CANDIDATE_DIRECTION_SLICE_ACCURACY_EDGE_MARGIN"
  ENTRY_DIRECTION_SLICE_CONFUSION_PAIR_WEIGHT="$CANDIDATE_DIRECTION_SLICE_CONFUSION_PAIR_WEIGHT"
  ENTRY_DIRECTION_SLICE_CONFUSION_PAIR_MARGIN="$CANDIDATE_DIRECTION_SLICE_CONFUSION_PAIR_MARGIN"
  ENTRY_DIRECTION_SLICE_ACCURACY_EDGE_MIN_LABEL_RATE="$CANDIDATE_DIRECTION_SLICE_ACCURACY_EDGE_MIN_LABEL_RATE"
  ENTRY_DIRECTION_SLICE_ACCURACY_EDGE_MIN_ROWS="$CANDIDATE_DIRECTION_SLICE_ACCURACY_EDGE_MIN_ROWS"
  ENTRY_DIRECTION_SLICE_PRIOR_MATCH_WEIGHT="$CANDIDATE_DIRECTION_SLICE_PRIOR_MATCH_WEIGHT"
  ENTRY_DIRECTION_SLICE_PRIOR_MATCH_TOLERANCE="$CANDIDATE_DIRECTION_SLICE_PRIOR_MATCH_TOLERANCE"
  ENTRY_DIRECTION_SLICE_PRIOR_MATCH_MIN_LABEL_RATE="$CANDIDATE_DIRECTION_SLICE_PRIOR_MATCH_MIN_LABEL_RATE"
  ENTRY_DIRECTION_SLICE_PRIOR_MATCH_MIN_ROWS="$CANDIDATE_DIRECTION_SLICE_PRIOR_MATCH_MIN_ROWS"
  ENTRY_DIRECTION_SLICE_LOSS_AGGREGATION="$CANDIDATE_DIRECTION_SLICE_LOSS_AGGREGATION"
  ENTRY_DIRECTION_SLICE_BALANCED_SAMPLER="$CANDIDATE_DIRECTION_SLICE_BALANCED_SAMPLER"
  ENTRY_DIRECTION_SLICE_BALANCED_SAMPLER_MIN_ROWS="$CANDIDATE_DIRECTION_SLICE_BALANCED_SAMPLER_MIN_ROWS"
  ENTRY_DIRECTION_SLICE_HARD_RED_STOP_PATIENCE="$CANDIDATE_DIRECTION_SLICE_HARD_RED_STOP_PATIENCE"
  ENTRY_DIRECTION_SLICE_HARD_RED_STOP_MIN_EPOCHS="$CANDIDATE_DIRECTION_SLICE_HARD_RED_STOP_MIN_EPOCHS"
  ...
  ENTRY_DIRECTION_UTILITY_MARGIN_WEIGHT="$CANDIDATE_DIRECTION_UTILITY_MARGIN_WEIGHT"
  ENTRY_DIRECTION_UTILITY_MIN_GAP_BPS="$CANDIDATE_DIRECTION_UTILITY_MIN_GAP_BPS"
  ENTRY_DIRECTION_UTILITY_LOGIT_MARGIN="$CANDIDATE_DIRECTION_UTILITY_LOGIT_MARGIN"
  ENTRY_DIRECTION_SIDE_UTILITY_CONVICTION_WEIGHT="$CANDIDATE_DIRECTION_SIDE_UTILITY_CONVICTION_WEIGHT"
  ENTRY_DIRECTION_SIDE_UTILITY_CONVICTION_MIN_GAP_BPS="$CANDIDATE_DIRECTION_SIDE_UTILITY_CONVICTION_MIN_GAP_BPS"
  ENTRY_DIRECTION_SIDE_UTILITY_CONVICTION_LOGIT_MARGIN="$CANDIDATE_DIRECTION_SIDE_UTILITY_CONVICTION_LOGIT_MARGIN"
  ENTRY_DIRECTION_UTILITY_TRADE_CONVICTION_WEIGHT="$CANDIDATE_DIRECTION_UTILITY_TRADE_CONVICTION_WEIGHT"
  ENTRY_DIRECTION_UTILITY_TRADE_CONVICTION_MIN_GAP_BPS="$CANDIDATE_DIRECTION_UTILITY_TRADE_CONVICTION_MIN_GAP_BPS"
  ENTRY_DIRECTION_UTILITY_TRADE_CONVICTION_MIN_UTILITY_BPS="$CANDIDATE_DIRECTION_UTILITY_TRADE_CONVICTION_MIN_UTILITY_BPS"
  ENTRY_DIRECTION_UTILITY_TRADE_CONVICTION_MAX_BAD_PATH="$CANDIDATE_DIRECTION_UTILITY_TRADE_CONVICTION_MAX_BAD_PATH"
  ENTRY_DIRECTION_UTILITY_TRADE_CONVICTION_LOGIT_MARGIN="$CANDIDATE_DIRECTION_UTILITY_TRADE_CONVICTION_LOGIT_MARGIN"
  ENTRY_DIRECTION_UTILITY_TRIAD_CE_WEIGHT="$CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_WEIGHT"
  ENTRY_DIRECTION_UTILITY_TRIAD_CE_MIN_GAP_BPS="$CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_MIN_GAP_BPS"
  ENTRY_DIRECTION_UTILITY_TRIAD_CE_MIN_UTILITY_BPS="$CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_MIN_UTILITY_BPS"
  ENTRY_DIRECTION_UTILITY_TRIAD_CE_MAX_BAD_PATH="$CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_MAX_BAD_PATH"
  ENTRY_DIRECTION_UTILITY_TRIAD_CE_CLASS_WEIGHT_CAP="$CANDIDATE_DIRECTION_UTILITY_TRIAD_CE_CLASS_WEIGHT_CAP"
  ENTRY_DIRECTION_HIERARCHICAL_COMPOSITION="$CANDIDATE_DIRECTION_HIERARCHICAL_COMPOSITION"
  ENTRY_HIER_COMPOSE_RESIDUAL_LOGIT_CAP="$CANDIDATE_HIER_COMPOSE_RESIDUAL_LOGIT_CAP"
  ENTRY_HIER_COMPOSE_RESIDUAL_SIDE_NEUTRAL="$CANDIDATE_HIER_COMPOSE_RESIDUAL_SIDE_NEUTRAL"
  ...
  ENTRY_HIER_PUBLIC_TRADE_HEAD="$CANDIDATE_HIER_PUBLIC_TRADE_HEAD"
  ENTRY_HIER_PUBLIC_FLAT_HEAD="$CANDIDATE_HIER_PUBLIC_FLAT_HEAD"
  ...
  ENTRY_HIER_PUBLIC_SIDE_HEAD="$CANDIDATE_HIER_PUBLIC_SIDE_HEAD"
  ...
  ENTRY_HIER_CTX_PRIOR_ADAPTER="$CANDIDATE_HIER_CTX_PRIOR_ADAPTER"
  ENTRY_HIER_CTX_PRIOR_ADAPTER_SCALE="$CANDIDATE_HIER_CTX_PRIOR_ADAPTER_SCALE"
  ENTRY_HIER_CTX_DIRECTION_CALIBRATION="$CANDIDATE_HIER_CTX_DIRECTION_CALIBRATION"
  ...
  ENTRY_DIRECTION_FLAT_STARVATION_WEIGHT="$CANDIDATE_DIRECTION_FLAT_STARVATION_WEIGHT"
  ENTRY_DIRECTION_FLAT_STARVATION_MIN_LABEL_RATE="$CANDIDATE_DIRECTION_FLAT_STARVATION_MIN_LABEL_RATE"
  ENTRY_DIRECTION_FLAT_STARVATION_MIN_ROWS="$CANDIDATE_DIRECTION_FLAT_STARVATION_MIN_ROWS"
  ENTRY_DIRECTION_FLAT_STARVATION_PRED_FRACTION="$CANDIDATE_DIRECTION_FLAT_STARVATION_PRED_FRACTION"
  ENTRY_DIRECTION_FLAT_STARVATION_PRED_FLOOR="$CANDIDATE_DIRECTION_FLAT_STARVATION_PRED_FLOOR"
  ENTRY_DIRECTION_FLAT_STARVATION_LOGIT_MARGIN="$CANDIDATE_DIRECTION_FLAT_STARVATION_LOGIT_MARGIN"
  ...
  ENTRY_RESIDUAL_SCALE="$CANDIDATE_RESIDUAL_SCALE"
  ENTRY_ANCHOR_EPS="$CANDIDATE_ANCHOR_EPS"
  ...
  ENTRY_HIER_TRADE_GLOBAL_PRIOR_MATCH_WEIGHT="$CANDIDATE_HIER_TRADE_GLOBAL_PRIOR_MATCH_WEIGHT"
  ENTRY_HIER_TRADE_GLOBAL_PRIOR_MATCH_TOLERANCE="$CANDIDATE_HIER_TRADE_GLOBAL_PRIOR_MATCH_TOLERANCE"
  ENTRY_HIER_TRADE_GLOBAL_PRIOR_MATCH_MIN_LABEL_RATE="$CANDIDATE_HIER_TRADE_GLOBAL_PRIOR_MATCH_MIN_LABEL_RATE"
  ENTRY_HIER_SLICE_TRADE_PRIOR_MATCH_WEIGHT="$CANDIDATE_HIER_SLICE_TRADE_PRIOR_MATCH_WEIGHT"
  ENTRY_HIER_SLICE_TRADE_PRIOR_MATCH_TOLERANCE="$CANDIDATE_HIER_SLICE_TRADE_PRIOR_MATCH_TOLERANCE"
  ENTRY_HIER_SLICE_TRADE_PRIOR_MATCH_MIN_LABEL_RATE="$CANDIDATE_HIER_SLICE_TRADE_PRIOR_MATCH_MIN_LABEL_RATE"
  ENTRY_HIER_SLICE_TRADE_PRIOR_MATCH_MIN_ROWS="$CANDIDATE_HIER_SLICE_TRADE_PRIOR_MATCH_MIN_ROWS"
  ENTRY_HIER_SLICE_TRADE_ACCURACY_EDGE_WEIGHT="$CANDIDATE_HIER_SLICE_TRADE_ACCURACY_EDGE_WEIGHT"
  ENTRY_HIER_SLICE_TRADE_ACCURACY_EDGE_MARGIN="$CANDIDATE_HIER_SLICE_TRADE_ACCURACY_EDGE_MARGIN"
  ENTRY_HIER_FLAT_LOGIT_MARGIN_WEIGHT="$CANDIDATE_HIER_FLAT_LOGIT_MARGIN_WEIGHT"
  ENTRY_HIER_FLAT_LOGIT_MARGIN="$CANDIDATE_HIER_FLAT_LOGIT_MARGIN"
  ENTRY_HIER_FLAT_LOGIT_MARGIN_MIN_LABEL_RATE="$CANDIDATE_HIER_FLAT_LOGIT_MARGIN_MIN_LABEL_RATE"
  ENTRY_HIER_SLICE_FLAT_LOGIT_MARGIN_WEIGHT="$CANDIDATE_HIER_SLICE_FLAT_LOGIT_MARGIN_WEIGHT"
  ENTRY_HIER_SLICE_FLAT_LOGIT_MARGIN="$CANDIDATE_HIER_SLICE_FLAT_LOGIT_MARGIN"
  ENTRY_HIER_SLICE_FLAT_LOGIT_MARGIN_MIN_LABEL_RATE="$CANDIDATE_HIER_SLICE_FLAT_LOGIT_MARGIN_MIN_LABEL_RATE"
  ENTRY_HIER_SLICE_FLAT_LOGIT_MARGIN_MIN_ROWS="$CANDIDATE_HIER_SLICE_FLAT_LOGIT_MARGIN_MIN_ROWS"
  ENTRY_HIER_PUBLIC_FLAT_CONSISTENCY_WEIGHT="$CANDIDATE_HIER_PUBLIC_FLAT_CONSISTENCY_WEIGHT"
  ENTRY_HIER_PUBLIC_FLAT_CONSISTENCY_MIN_LABEL_RATE="$CANDIDATE_HIER_PUBLIC_FLAT_CONSISTENCY_MIN_LABEL_RATE"
  ENTRY_HIER_SLICE_PUBLIC_FLAT_CONSISTENCY_WEIGHT="$CANDIDATE_HIER_SLICE_PUBLIC_FLAT_CONSISTENCY_WEIGHT"
  ENTRY_HIER_SLICE_PUBLIC_FLAT_CONSISTENCY_MIN_LABEL_RATE="$CANDIDATE_HIER_SLICE_PUBLIC_FLAT_CONSISTENCY_MIN_LABEL_RATE"
  ENTRY_HIER_SLICE_PUBLIC_FLAT_CONSISTENCY_MIN_ROWS="$CANDIDATE_HIER_SLICE_PUBLIC_FLAT_CONSISTENCY_MIN_ROWS"
  ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN_WEIGHT="$CANDIDATE_HIER_PUBLIC_TRADE_FLAT_MARGIN_WEIGHT"
  ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN="$CANDIDATE_HIER_PUBLIC_TRADE_FLAT_MARGIN"
  ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN_MIN_LABEL_RATE="$CANDIDATE_HIER_PUBLIC_TRADE_FLAT_MARGIN_MIN_LABEL_RATE"
  ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_WEIGHT="$CANDIDATE_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_WEIGHT"
  ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN="$CANDIDATE_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN"
  ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_MIN_LABEL_RATE="$CANDIDATE_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_MIN_LABEL_RATE"
  ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_MIN_ROWS="$CANDIDATE_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_MIN_ROWS"
  ENTRY_HIER_SLICE_SIDE_CE_WEIGHT="$CANDIDATE_HIER_SLICE_SIDE_CE_WEIGHT"
  ENTRY_HIER_SLICE_SIDE_TRUE_MARGIN_WEIGHT="$CANDIDATE_HIER_SLICE_SIDE_TRUE_MARGIN_WEIGHT"
  ENTRY_HIER_SLICE_SIDE_TRUE_MARGIN="$CANDIDATE_HIER_SLICE_SIDE_TRUE_MARGIN"
  ENTRY_HIER_SLICE_SIDE_ACCURACY_EDGE_WEIGHT="$CANDIDATE_HIER_SLICE_SIDE_ACCURACY_EDGE_WEIGHT"
  ENTRY_HIER_SLICE_SIDE_ACCURACY_EDGE_MARGIN="$CANDIDATE_HIER_SLICE_SIDE_ACCURACY_EDGE_MARGIN"
  ENTRY_HIER_SLICE_SIDE_MIN_LABEL_RATE="$CANDIDATE_HIER_SLICE_SIDE_MIN_LABEL_RATE"
  ENTRY_HIER_SLICE_SIDE_MIN_ROWS="$CANDIDATE_HIER_SLICE_SIDE_MIN_ROWS"
  ENTRY_HIER_SIDE_GLOBAL_PRIOR_MATCH_WEIGHT="$CANDIDATE_HIER_SIDE_GLOBAL_PRIOR_MATCH_WEIGHT"
  ENTRY_HIER_SIDE_GLOBAL_PRIOR_MATCH_TOLERANCE="$CANDIDATE_HIER_SIDE_GLOBAL_PRIOR_MATCH_TOLERANCE"
  ENTRY_HIER_SIDE_GLOBAL_PRIOR_MATCH_MIN_LABEL_RATE="$CANDIDATE_HIER_SIDE_GLOBAL_PRIOR_MATCH_MIN_LABEL_RATE"
  ENTRY_HIER_SLICE_SIDE_PRIOR_MATCH_WEIGHT="$CANDIDATE_HIER_SLICE_SIDE_PRIOR_MATCH_WEIGHT"
  ENTRY_HIER_SLICE_SIDE_PRIOR_MATCH_TOLERANCE="$CANDIDATE_HIER_SLICE_SIDE_PRIOR_MATCH_TOLERANCE"
  ENTRY_HIER_SLICE_SIDE_PRIOR_MATCH_MIN_LABEL_RATE="$CANDIDATE_HIER_SLICE_SIDE_PRIOR_MATCH_MIN_LABEL_RATE"
  ENTRY_HIER_SLICE_SIDE_PRIOR_MATCH_MIN_ROWS="$CANDIDATE_HIER_SLICE_SIDE_PRIOR_MATCH_MIN_ROWS"
...
def report_json_path(report: dict, default_path: str | Path) -> str:
