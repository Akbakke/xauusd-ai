  ...
  case "$1" in
    ...
    --smart-seq520)
      ...
      if [[ -z "${ENTRY_FOUNDATION_SMOKE_DIRECTION_MIN_PRED_RATE_SOFTMAX_TEMPERATURE+x}" ]]; then
        SMOKE_DIRECTION_MIN_PRED_RATE_SOFTMAX_TEMPERATURE=0.15
      else
        echo "WARNING: smart auto-recipe DIRECTION_MIN_PRED_RATE_SOFTMAX_TEMPERATURE=0.15 overridden by env: ${SMOKE_DIRECTION_MIN_PRED_RATE_SOFTMAX_TEMPERATURE}" >&2
      fi
