...
echo "=================================================================================="
echo "GATE 1: Poisoned Import Test"
echo "=================================================================================="
echo ""
echo "Mål:"
echo "  - Importere runner (uten å skape den)"
echo "  - Starte worker client"
echo "  - Kjøre predict-batch"
echo "  - Shutdown"
echo ""
echo "Dette er den viktigste testen for å bevise at arkitektur A faktisk løser root cause."
echo ""

TIMEOUT=90  # 90 sekunder timeout
