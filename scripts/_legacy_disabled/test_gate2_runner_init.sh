...
echo "=================================================================================="
echo "GATE 2: Runner Init + Inference Test"
echo "=================================================================================="
echo ""
echo "Mål:"
echo "  - Konstruere GX1DemoRunner med V10.1 policy"
echo "  - Verifisere entry_v10_enabled=True"
echo "  - Verifisere worker-pid settes"
echo "  - Kjøre én prediksjon"
echo "  - Verifisere destructor cleanup"
echo ""
echo "Policy: $POLICY"
echo ""

TIMEOUT=120  # 2 minutter timeout
