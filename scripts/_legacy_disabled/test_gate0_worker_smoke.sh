...
echo "=================================================================================="
echo "GATE 0: Worker Smoke Test"
echo "=================================================================================="
echo ""
echo "Mål:"
echo "  - Worker kan starte"
echo "  - Laster CANONICAL checkpoint"
echo "  - Returnerer p_long på dummy batch"
echo "  - Shutdown clean"
echo ""

TIMEOUT=60  # 60 sekunder timeout
