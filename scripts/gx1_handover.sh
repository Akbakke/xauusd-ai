...
echo "resume_stage: RUN_V40_LOW_VRAM_DESIGN_BEFORE_ANY_HISTORICAL_CUDA_TRAINING"
...
echo "  1. model-native-attended-hardware-smoke only (no data or bundle authority)"
echo "  2. design and prove low-VRAM resumable historical CUDA training"
echo "  3. only then bind a new train recipe -> smoke bundle audit -> candidate readiness"
