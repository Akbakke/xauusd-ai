...
echo "source_regression_last_verified: 2026-08-27 after the V46 status reconciliation; full capped pytest suite passed with zero failures, skips or warnings"
...
echo "resume_stage: OFFLINE_V46_RESEARCH_SMOKE_THEN_CANDIDATE_THEN_HISTORICAL_OOS"
...
echo "  1. run the bounded V46 offline research smoke and audit its bundle"
echo "  2. train the full research candidate only after smoke validity and hardware safety pass"
