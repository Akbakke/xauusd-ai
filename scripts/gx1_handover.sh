...
echo "resume_stage: RUN_ONE_V40_LOW_VRAM_HISTORICAL_DIAGNOSTIC"
...
echo "  1. fresh recipe audit -> one attended batch-8/two-step historical diagnostic (no bundle authority)"
echo "  2. inspect its capped VRAM/power/thermal result; long-running CUDA remains disabled"
