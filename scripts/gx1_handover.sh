...
echo "train_recipe: V42_OLD_RECIPE_BLOCKED_BY_EXECUTION_CAUSALITY_AUDIT"
...
echo "dataset_rebuild: REQUIRED_BEFORE_ANY_V42_SUCCESSOR_TRAINING"
...
echo "  1. rebuild all active auxiliary labels from exact M1 decision/fill bid/ask evidence"
