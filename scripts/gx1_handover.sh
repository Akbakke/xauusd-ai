...
echo "resume_stage: RUN_V40_REMAINING_ADMISSION_GATES_THEN_BOUNDED_SMOKE"
...
echo "  1. bind V40 feature/target/specialist audits and run remaining admission gates"
