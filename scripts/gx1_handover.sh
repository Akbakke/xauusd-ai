...
echo "resume_stage: LOCAL_CUDA_THERMAL_HOLD_THEN_APPROVED_REMOTE_SMOKE_THEN_CANDIDATE_THEN_HISTORICAL_OOS"
...
echo "local_cuda: HOLD_TWO_CANONICAL_71C_GUARD_STOPS_NO_NEW_LOCAL_CUDA_RETRY"
...
echo "  1. do not retry local CUDA; prepare an approved remote V46 canonical smoke and audit its bundle"
echo "  2. train the full research candidate only after remote smoke validity and hardware safety pass"
