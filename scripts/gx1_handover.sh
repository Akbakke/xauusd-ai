...
echo "dataset_rebuild: REQUIRED_AFTER_PRODUCTION_ECONOMICS_BINDING_BEFORE_CANDIDATE_TRAINING"
...
echo "  1. bind immutable historical broker costs and financing to the causal M1 decision/fill evidence"
