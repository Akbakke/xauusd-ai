...
echo "train_recipe: V9_FULL_TECHNICAL_TRAIN_VAL_FROZEN__CURRENT_SOURCE_32_ROW_TECHNICAL_SMOKE_EXECUTED__POSTRUN_AUDIT_PENDING__NO_CANDIDATE_OR_PROMOTION_AUTHORITY"
...
echo "fresh_31004_train: BLOCKED_PENDING_CLEAN_PREFLIGHT_AND_EXPLICIT_REAUTHORIZATION"
...
echo "current_cuda_authority: NO_FURTHER_CUDA_AUTHORITY__TECHNICAL_SMOKE_EXECUTED__POSTRUN_AUDIT_PENDING"
