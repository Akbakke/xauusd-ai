...
echo "fresh_31004_train: BLOCKED_PENDING_FRESH_SIGNED_HOST_TELEMETRY_AND_EXPLICIT_REAUTHORIZATION"
...
echo "host_telemetry: POST_RESTART_WSL_SIGNED_ENDPOINT_LAST_HTTP_503__FRESH_SIGNED_PROBE_REQUIRED"
echo "current_cuda_authority: BLOCKED_PENDING_FRESH_SIGNED_TELEMETRY_160W_PHYSICAL_LIMIT_PRECHECK_AND_EXPLICIT_REAUTHORIZATION"
...
echo "  2. restore the signed Windows-to-WSL telemetry bridge and freshly verify numeric telemetry plus the 160 W physical limit; do not launch CUDA while it returns HTTP 503"
