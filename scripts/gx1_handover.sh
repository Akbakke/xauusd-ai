...
echo "resume_stage: RUN_V40_GUARDED_RESEARCH_SMOKE_THEN_SMOKE_BUNDLE_AUDIT"
...
echo "  1. bind V40 feature/target/specialist audits and the train recipe"
echo "  2. model-native-research-smoke-train -> model-native-smoke-bundle-audit"
