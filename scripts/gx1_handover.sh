...
echo "source_regression: PASS_1991_TESTS_ZERO_SKIPS_ZERO_WARNINGS"
echo
echo "## Fixed architecture"
echo "featurebase: SAME_8_OWNERS_FORMULAS_NORMALIZATION_LINEAGE"
echo "entry: M5 sequence=96 signal=513 ctx_cont=142 ctx_cat=5 mtf=M5,M15,H1,H4,D1"
echo "exit: M1 sequence=480 same_featurebase_plus_causal_path shared_encoder=true"
