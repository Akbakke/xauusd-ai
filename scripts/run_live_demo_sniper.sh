...
#
# Archived: 2026-01-16
# Archive location: archive/legacy_20260116/run_live_demo_sniper.sh
...
if [ "${ALLOW_LEGACY:-}" != "1" ]; then
    ...
    echo "  ALLOW_LEGACY=1 ./scripts/run_live_demo_sniper.sh"
    exit 1
fi

# If ALLOW_LEGACY=1, load from archive
ARCHIVE_SCRIPT="archive/legacy_20260116/run_live_demo_sniper.sh"
