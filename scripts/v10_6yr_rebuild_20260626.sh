...
export ENTRY_CKPT_DIRECTION_SLICE_GUARD=${ENTRY_CKPT_DIRECTION_SLICE_GUARD:-1}
...
export ENTRY_DIRECTION_GLOBAL_PRIOR_MATCH_WEIGHT=${ENTRY_DIRECTION_GLOBAL_PRIOR_MATCH_WEIGHT:-8.00}
export ENTRY_DIRECTION_GLOBAL_PRIOR_MATCH_TOLERANCE=${ENTRY_DIRECTION_GLOBAL_PRIOR_MATCH_TOLERANCE:-0.02}
export ENTRY_DIRECTION_GLOBAL_PRIOR_MATCH_MIN_LABEL_RATE=${ENTRY_DIRECTION_GLOBAL_PRIOR_MATCH_MIN_LABEL_RATE:-0.10}
export ENTRY_DIRECTION_SLICE_MIN_PRED_RATE_LOSS_WEIGHT=${ENTRY_DIRECTION_SLICE_MIN_PRED_RATE_LOSS_WEIGHT:-8.00}
export ENTRY_DIRECTION_SLICE_MIN_PRED_RATE_FRACTION=${ENTRY_DIRECTION_SLICE_MIN_PRED_RATE_FRACTION:-0.50}
export ENTRY_DIRECTION_SLICE_MIN_PRED_RATE_FLOOR=${ENTRY_DIRECTION_SLICE_MIN_PRED_RATE_FLOOR:-0.05}
export ENTRY_DIRECTION_SLICE_MIN_LABEL_RATE=${ENTRY_DIRECTION_SLICE_MIN_LABEL_RATE:-0.10}
export ENTRY_DIRECTION_SLICE_MIN_ROWS=${ENTRY_DIRECTION_SLICE_MIN_ROWS:-8}
export ENTRY_DIRECTION_SLICE_CTX_CAT_INDICES=${ENTRY_DIRECTION_SLICE_CTX_CAT_INDICES:-0,1,2,3,4}
export ENTRY_DIRECTION_SLICE_RECALL_LOSS_WEIGHT=${ENTRY_DIRECTION_SLICE_RECALL_LOSS_WEIGHT:-4.00}
export ENTRY_DIRECTION_SLICE_RECALL_PROB_FLOOR=${ENTRY_DIRECTION_SLICE_RECALL_PROB_FLOOR:-0.30}
export ENTRY_DIRECTION_SLICE_RECALL_MIN_LABEL_RATE=${ENTRY_DIRECTION_SLICE_RECALL_MIN_LABEL_RATE:-0.10}
export ENTRY_DIRECTION_SLICE_RECALL_MIN_ROWS=${ENTRY_DIRECTION_SLICE_RECALL_MIN_ROWS:-8}
export ENTRY_DIRECTION_SLICE_BALANCED_CE_WEIGHT=${ENTRY_DIRECTION_SLICE_BALANCED_CE_WEIGHT:-2.00}
export ENTRY_DIRECTION_SLICE_BALANCED_CE_MIN_LABEL_RATE=${ENTRY_DIRECTION_SLICE_BALANCED_CE_MIN_LABEL_RATE:-0.10}
export ENTRY_DIRECTION_SLICE_BALANCED_CE_MIN_ROWS=${ENTRY_DIRECTION_SLICE_BALANCED_CE_MIN_ROWS:-8}
export ENTRY_DIRECTION_SLICE_TRUE_MARGIN_WEIGHT=${ENTRY_DIRECTION_SLICE_TRUE_MARGIN_WEIGHT:-2.00}
export ENTRY_DIRECTION_SLICE_TRUE_MARGIN=${ENTRY_DIRECTION_SLICE_TRUE_MARGIN:-0.10}
export ENTRY_DIRECTION_SLICE_TRUE_MARGIN_MIN_LABEL_RATE=${ENTRY_DIRECTION_SLICE_TRUE_MARGIN_MIN_LABEL_RATE:-0.10}
export ENTRY_DIRECTION_SLICE_TRUE_MARGIN_MIN_ROWS=${ENTRY_DIRECTION_SLICE_TRUE_MARGIN_MIN_ROWS:-8}
export ENTRY_DIRECTION_SLICE_ACCURACY_EDGE_WEIGHT=${ENTRY_DIRECTION_SLICE_ACCURACY_EDGE_WEIGHT:-4.00}
export ENTRY_DIRECTION_SLICE_ACCURACY_EDGE_MARGIN=${ENTRY_DIRECTION_SLICE_ACCURACY_EDGE_MARGIN:-0.02}
export ENTRY_DIRECTION_SLICE_CONFUSION_PAIR_WEIGHT=${ENTRY_DIRECTION_SLICE_CONFUSION_PAIR_WEIGHT:-4.00}
export ENTRY_DIRECTION_SLICE_CONFUSION_PAIR_MARGIN=${ENTRY_DIRECTION_SLICE_CONFUSION_PAIR_MARGIN:-0.02}
export ENTRY_DIRECTION_SLICE_ACCURACY_EDGE_MIN_LABEL_RATE=${ENTRY_DIRECTION_SLICE_ACCURACY_EDGE_MIN_LABEL_RATE:-0.10}
export ENTRY_DIRECTION_SLICE_ACCURACY_EDGE_MIN_ROWS=${ENTRY_DIRECTION_SLICE_ACCURACY_EDGE_MIN_ROWS:-8}
export ENTRY_DIRECTION_SLICE_PRIOR_MATCH_WEIGHT=${ENTRY_DIRECTION_SLICE_PRIOR_MATCH_WEIGHT:-3.00}
export ENTRY_DIRECTION_SLICE_PRIOR_MATCH_TOLERANCE=${ENTRY_DIRECTION_SLICE_PRIOR_MATCH_TOLERANCE:-0.02}
export ENTRY_DIRECTION_SLICE_PRIOR_MATCH_MIN_LABEL_RATE=${ENTRY_DIRECTION_SLICE_PRIOR_MATCH_MIN_LABEL_RATE:-0.10}
export ENTRY_DIRECTION_SLICE_PRIOR_MATCH_MIN_ROWS=${ENTRY_DIRECTION_SLICE_PRIOR_MATCH_MIN_ROWS:-8}
export ENTRY_DIRECTION_SLICE_LOSS_AGGREGATION=${ENTRY_DIRECTION_SLICE_LOSS_AGGREGATION:-mean_max}
export ENTRY_DIRECTION_SLICE_BALANCED_SAMPLER=${ENTRY_DIRECTION_SLICE_BALANCED_SAMPLER:-1}
export ENTRY_DIRECTION_SLICE_BALANCED_SAMPLER_MIN_ROWS=${ENTRY_DIRECTION_SLICE_BALANCED_SAMPLER_MIN_ROWS:-8}
export ENTRY_DIRECTION_SLICE_HARD_RED_STOP_PATIENCE=${ENTRY_DIRECTION_SLICE_HARD_RED_STOP_PATIENCE:-3}
export ENTRY_DIRECTION_SLICE_HARD_RED_STOP_MIN_EPOCHS=${ENTRY_DIRECTION_SLICE_HARD_RED_STOP_MIN_EPOCHS:-6}
...
export ENTRY_HIER_COMPOSE_PUBLIC_FLAT_FROM_TRADE=${ENTRY_HIER_COMPOSE_PUBLIC_FLAT_FROM_TRADE:-1}
export ENTRY_HIER_PUBLIC_DIRECTION_COMPOSITION=${ENTRY_HIER_PUBLIC_DIRECTION_COMPOSITION:-margin_maxnorm_confidence}
export ENTRY_HIER_PUBLIC_DIRECTION_DETACH_SIDE_GRAD=${ENTRY_HIER_PUBLIC_DIRECTION_DETACH_SIDE_GRAD:-1}
export ENTRY_HIER_PUBLIC_TRADE_HEAD=${ENTRY_HIER_PUBLIC_TRADE_HEAD:-1}
export ENTRY_HIER_PUBLIC_FLAT_HEAD=${ENTRY_HIER_PUBLIC_FLAT_HEAD:-1}
export ENTRY_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE=${ENTRY_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE:-1}
export ENTRY_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE_SCALE=${ENTRY_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE_SCALE:-0.50}
export ENTRY_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE_CAP=${ENTRY_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE_CAP:-0.25}
export ENTRY_HIER_PUBLIC_SIDE_HEAD=${ENTRY_HIER_PUBLIC_SIDE_HEAD:-1}
export ENTRY_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE=${ENTRY_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE:-1}
export ENTRY_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE_SCALE=${ENTRY_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE_SCALE:-0.50}
export ENTRY_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE_CAP=${ENTRY_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE_CAP:-0.25}
export ENTRY_HIER_PUBLIC_SIDE_HEAD_RESIDUAL_CAP_WEIGHT=${ENTRY_HIER_PUBLIC_SIDE_HEAD_RESIDUAL_CAP_WEIGHT:-8.00}
export ENTRY_HIER_PUBLIC_SIDE_HEAD_RESIDUAL_CAP=${ENTRY_HIER_PUBLIC_SIDE_HEAD_RESIDUAL_CAP:-0.20}
export ENTRY_HIER_CTX_PRIOR_ADAPTER=${ENTRY_HIER_CTX_PRIOR_ADAPTER:-1}
export ENTRY_HIER_CTX_PRIOR_ADAPTER_SCALE=${ENTRY_HIER_CTX_PRIOR_ADAPTER_SCALE:-0.50}
export ENTRY_HIER_CTX_DIRECTION_CALIBRATION=${ENTRY_HIER_CTX_DIRECTION_CALIBRATION:-1}
export ENTRY_HIER_CTX_DIRECTION_CALIBRATION_SCALE=${ENTRY_HIER_CTX_DIRECTION_CALIBRATION_SCALE:-0.50}
export ENTRY_HIER_CTX_DIRECTION_CALIBRATION_CAP=${ENTRY_HIER_CTX_DIRECTION_CALIBRATION_CAP:-0.35}
...
export ENTRY_HIER_SLICE_TRADE_ACCURACY_EDGE_WEIGHT=${ENTRY_HIER_SLICE_TRADE_ACCURACY_EDGE_WEIGHT:-4.00}
export ENTRY_HIER_SLICE_TRADE_ACCURACY_EDGE_MARGIN=${ENTRY_HIER_SLICE_TRADE_ACCURACY_EDGE_MARGIN:-0.02}
export ENTRY_HIER_FLAT_LOGIT_MARGIN_WEIGHT=${ENTRY_HIER_FLAT_LOGIT_MARGIN_WEIGHT:-8.00}
export ENTRY_HIER_FLAT_LOGIT_MARGIN=${ENTRY_HIER_FLAT_LOGIT_MARGIN:-0.10}
export ENTRY_HIER_FLAT_LOGIT_MARGIN_MIN_LABEL_RATE=${ENTRY_HIER_FLAT_LOGIT_MARGIN_MIN_LABEL_RATE:-0.10}
export ENTRY_HIER_SLICE_FLAT_LOGIT_MARGIN_WEIGHT=${ENTRY_HIER_SLICE_FLAT_LOGIT_MARGIN_WEIGHT:-8.00}
export ENTRY_HIER_SLICE_FLAT_LOGIT_MARGIN=${ENTRY_HIER_SLICE_FLAT_LOGIT_MARGIN:-0.10}
export ENTRY_HIER_SLICE_FLAT_LOGIT_MARGIN_MIN_LABEL_RATE=${ENTRY_HIER_SLICE_FLAT_LOGIT_MARGIN_MIN_LABEL_RATE:-0.10}
export ENTRY_HIER_SLICE_FLAT_LOGIT_MARGIN_MIN_ROWS=${ENTRY_HIER_SLICE_FLAT_LOGIT_MARGIN_MIN_ROWS:-8}
export ENTRY_HIER_PUBLIC_FLAT_CONSISTENCY_WEIGHT=${ENTRY_HIER_PUBLIC_FLAT_CONSISTENCY_WEIGHT:-4.00}
export ENTRY_HIER_PUBLIC_FLAT_CONSISTENCY_MIN_LABEL_RATE=${ENTRY_HIER_PUBLIC_FLAT_CONSISTENCY_MIN_LABEL_RATE:-0.10}
export ENTRY_HIER_SLICE_PUBLIC_FLAT_CONSISTENCY_WEIGHT=${ENTRY_HIER_SLICE_PUBLIC_FLAT_CONSISTENCY_WEIGHT:-4.00}
export ENTRY_HIER_SLICE_PUBLIC_FLAT_CONSISTENCY_MIN_LABEL_RATE=${ENTRY_HIER_SLICE_PUBLIC_FLAT_CONSISTENCY_MIN_LABEL_RATE:-0.10}
export ENTRY_HIER_SLICE_PUBLIC_FLAT_CONSISTENCY_MIN_ROWS=${ENTRY_HIER_SLICE_PUBLIC_FLAT_CONSISTENCY_MIN_ROWS:-8}
export ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN_WEIGHT=${ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN_WEIGHT:-6.00}
export ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN=${ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN:-0.10}
export ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN_MIN_LABEL_RATE=${ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN_MIN_LABEL_RATE:-0.10}
export ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_WEIGHT=${ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_WEIGHT:-6.00}
export ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN=${ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN:-0.10}
export ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_MIN_LABEL_RATE=${ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_MIN_LABEL_RATE:-0.10}
export ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_MIN_ROWS=${ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_MIN_ROWS:-8}
...
export ENTRY_HIER_SLICE_SIDE_ACCURACY_EDGE_WEIGHT=${ENTRY_HIER_SLICE_SIDE_ACCURACY_EDGE_WEIGHT:-4.00}
export ENTRY_HIER_SLICE_SIDE_ACCURACY_EDGE_MARGIN=${ENTRY_HIER_SLICE_SIDE_ACCURACY_EDGE_MARGIN:-0.02}
