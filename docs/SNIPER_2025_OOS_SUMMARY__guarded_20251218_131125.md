# SNIPER 2025 Out-of-Sample Summary (Q1-Q4, variant=guarded)

**Computed from quarters**: Q1 (missing: none)
...
| --- | --- | --- | --- |
| Q1 | 153.85 | baseline | no |
| Q2 | missing | N/A | no |
| Q3 | missing | N/A | no |
| Q4 | missing | N/A | no |

### Win Rate
| Quarter | Win Rate | Change vs Q1 | Included in OOS avg |
| --- | --- | --- | --- |
| Q1 | 84.8% | baseline | no |
| Q2 | missing | N/A | no |
| Q3 | missing | N/A | no |
...
### Payoff Ratio
| Quarter | Payoff | Change vs Q1 | Included in OOS avg |
| --- | --- | --- | --- |
| Q1 | 3.13 | baseline | no |
| Q2 | missing | N/A | no |
| Q3 | missing | N/A | no |
...
| --- | --- | --- | --- |
| Q1 | 160.83 | 152.49 | 148.40 |
| Q2 | missing | missing | missing |
| Q3 | missing | missing | missing |
| Q4 | missing | missing | missing |
