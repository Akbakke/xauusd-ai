...
**actual draw** boundary is 300 W in canonical mode. The operator approved
this measured ceiling after the 251 W guard stopped a safe first forward at
254.93 W; 390 W remains only the configured driver ceiling, never a workload
authorization. WSL currently reports
