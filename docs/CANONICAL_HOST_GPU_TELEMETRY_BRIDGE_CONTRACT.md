...
**actual draw** boundary is 250 W in canonical mode. WSL currently reports
...
65 C and 8,873 MiB, then the guard stopped it at 250.48 W. No optimizer step,
