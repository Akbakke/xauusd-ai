...
> execution routes remain blocked. A fresh signed 160 W response was verified
> on 2026-09-04 and is maintained by a persistent cap task, but telemetry must
> still be fresh at launch. No CUDA work is authorised without the remaining
> dataset-bound gate, preflight and operator gate.
