...
- exactly 479 specialist fields in the manifest-declared order: all 305
  code-owned outputs from ten registered causal feature layers first, followed
  by exactly 174 fields selected by deterministic TRAIN-only ranking;
...
The mandatory 305-field registry is owned by
...
support/resistance memory and MTF confluence. All 479 specialist fields must
...
arbitrary field list: it prepends the exact mandatory 305 and takes only 174
