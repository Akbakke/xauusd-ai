#!/usr/bin/env python3
"""
LEGACY DISABLED: use canonical ENTRY_V10_CTX dataset in gx1/models/entry_v10/entry_v10_ctx_train.py only.
"""

raise RuntimeError(
    "LEGACY_DISABLED: use canonical ENTRY_V10_CTX dataset in gx1/models/entry_v10/entry_v10_ctx_train.py only."
)
