...
def build_pretest_technical_launch(
    *,
    ...
    trainer_command = [
        ...
        "--unified-exit-lifecycle-v2-root-manifest-json",
        bound_path("unified_exit_lifecycle_v2_root_manifest"),
        "--train-unified-exit-lifecycle-v2-parquet",
        bound_path("train_unified_exit_lifecycle_v2_parquet"),
        "--train-unified-exit-lifecycle-v2-manifest-json",
        bound_path("train_unified_exit_lifecycle_v2_manifest"),
        "--val-unified-exit-lifecycle-v2-parquet",
        bound_path("val_unified_exit_lifecycle_v2_parquet"),
        "--val-unified-exit-lifecycle-v2-manifest-json",
        bound_path("val_unified_exit_lifecycle_v2_manifest"),
        "--unified-exit-v2-economics-readiness-json",
        bound_path("unified_exit_v2_economics_readiness"),
        "--train-unified-exit-v2-cost-authority-json",
        bound_path("train_unified_exit_v2_cost_authority"),
        "--val-unified-exit-v2-cost-authority-json",
        bound_path("val_unified_exit_v2_cost_authority"),
