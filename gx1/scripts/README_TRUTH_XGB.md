...
Canonical context contract (ONE UNIVERSE): **CTX6CAT6** base (ctx_cat_dim=6 fixed; ctx_cont_base=6, ctx_cont may extend via bundle metadata) + `signal_bridge_v1`. Alle referanser til 5/2 eller 5/4 er legacy og skal ikke brukes i TRUTH/SMOKE.
