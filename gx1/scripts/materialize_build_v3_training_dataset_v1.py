...
Output
------
Single jsonl file: /home/andre2/GX1_DATA/data/training/exit_v3_v5_training_2020_2026.jsonl
...
DEFAULT_OUT_PATH = Path("/home/andre2/GX1_DATA/data/training/exit_v3_v5_training_2020_2026")
...
TRADE_STATE_FEATURE_INDICES = [
    EXIT_IO_V5_CTX_EXTENDED_SMC_M1L512_FEATURES.index(n) for n in TRADE_STATE_FEATURE_NAMES
]
...
def precompute_m1_feature_vectors(
    *,
    ...
    """
    print(f"[{ACTION}] precompute: M1 bars={len(m1_df):,}, output_dim={EXIT_IO_V5_CTX_EXTENDED_SMC_M1L512_FEATURE_COUNT}",
          flush=True)
    n = len(m1_df)
    feat_mat = np.zeros((n, EXIT_IO_V5_CTX_EXTENDED_SMC_M1L512_FEATURE_COUNT), dtype=np.float32)
    ...
    for v5_idx, fname in enumerate(EXIT_IO_V5_CTX_EXTENDED_SMC_M1L512_FEATURES):
        if v5_idx < 7:
...
def main() -> None:
    ...
    manifest = {
        ...
        "feature_names_hash": EXIT_IO_V5_CTX_EXTENDED_SMC_M1L512_FEATURE_NAMES_HASH,
        "input_dim": int(EXIT_IO_V5_CTX_EXTENDED_SMC_M1L512_FEATURE_COUNT),
        "window_len": int(args.window_len),
        "max_bars_per_trade": int(args.max_bars_per_trade),
        "emit_stride": int(args.emit_stride),
