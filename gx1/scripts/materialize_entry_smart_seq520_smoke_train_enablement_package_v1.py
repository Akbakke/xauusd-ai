...
REQUIRED_DIRECTION_ENV = {
    ...
    "ENTRY_HIER_PUBLIC_DIRECTION_COMPOSITION": "margin",
...
def _dry_run_wrapper(
    *,
    ...
    return {
        ...
        "has_hier_public_direction_margin_composition": (
            "ENTRY_HIER_PUBLIC_DIRECTION_COMPOSITION=margin" in capped_line
        ),
...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    checks = [
        ...
        _check(
            ...
            and dry_run.get("has_hier_public_direction_margin_composition") is True
