...
def _dry_run_wrapper(
    *,
    ...
    return {
        ...
        "has_utility_triad_ce": "ENTRY_DIRECTION_UTILITY_TRIAD_CE_WEIGHT=8.00" in capped_line
        and "ENTRY_DIRECTION_UTILITY_TRIAD_CE_MIN_GAP_BPS=15.0" in capped_line
        ...
        "has_hier_public_flat_head": "ENTRY_HIER_PUBLIC_FLAT_HEAD=1" in capped_line,
        "has_hier_public_trade_dir_margin_bridge": (
            "ENTRY_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE=1" in capped_line
            and "ENTRY_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE_SCALE=0.50" in capped_line
            and "ENTRY_HIER_PUBLIC_TRADE_DIR_MARGIN_BRIDGE_CAP=0.25" in capped_line
        ),
        "has_hier_public_side_head": "ENTRY_HIER_PUBLIC_SIDE_HEAD=1" in capped_line,
        "has_hier_public_side_dir_margin_bridge": (
            "ENTRY_HIER_PUBLIC_SIDE_DIR_MARGIN_BRIDGE=1" in capped_line
        ...
        and "ENTRY_HIER_CTX_DIRECTION_CALIBRATION_SCALE=0.50" in capped_line
        and "ENTRY_HIER_CTX_DIRECTION_CALIBRATION_CAP=0.35" in capped_line,
        ...
        and "ENTRY_HIER_SLICE_TRADE_ACCURACY_EDGE_WEIGHT=4.00" in capped_line
        and "ENTRY_HIER_SLICE_TRADE_ACCURACY_EDGE_MARGIN=0.02" in capped_line,
        "has_hier_flat_logit_margin": "ENTRY_HIER_FLAT_LOGIT_MARGIN_WEIGHT=8.00" in capped_line
        and "ENTRY_HIER_FLAT_LOGIT_MARGIN=0.10" in capped_line
        and "ENTRY_HIER_FLAT_LOGIT_MARGIN_MIN_LABEL_RATE=0.10" in capped_line
        and "ENTRY_HIER_SLICE_FLAT_LOGIT_MARGIN_WEIGHT=8.00" in capped_line
        ...
        "has_hier_public_trade_flat_margin": (
            "ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN_WEIGHT=6.00" in capped_line
            and "ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN=0.10" in capped_line
            and "ENTRY_HIER_PUBLIC_TRADE_FLAT_MARGIN_MIN_LABEL_RATE=0.10" in capped_line
            and "ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_WEIGHT=6.00" in capped_line
            and "ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN=0.10" in capped_line
            and "ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_MIN_LABEL_RATE=0.10" in capped_line
            and "ENTRY_HIER_SLICE_PUBLIC_TRADE_FLAT_MARGIN_MIN_ROWS=8" in capped_line
        ),
        ...
        and "ENTRY_HIER_SLICE_SIDE_ACCURACY_EDGE_WEIGHT=4.00" in capped_line
        and "ENTRY_HIER_SLICE_SIDE_ACCURACY_EDGE_MARGIN=0.02" in capped_line
...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    checks = [
        ...
        _check(
            ...
            and dry_run.get("has_hier_public_flat_head") is True
            ...
            and dry_run.get("has_hier_public_trade_flat_margin") is True
