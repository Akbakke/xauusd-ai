...
# The integer schema tag written into `y_direction_target_mode_id` on every
# emitted row.  Named here, in the only module that writes the column, so the
# pre-train audit can bind the exact owner instead of restating the literal.
ENTRY_DIRECTION_TARGET_MODE_ID = 1
        ...
        pending.append(
            {
                ...
                "y_direction_target_mode_id": ENTRY_DIRECTION_TARGET_MODE_ID,
