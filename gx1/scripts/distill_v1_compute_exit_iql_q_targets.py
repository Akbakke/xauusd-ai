...
# 2026-05-20: defaults updated to v3+ winsorized bundle (the V12.4 cemented
# production bundle). Caller can override via --v3tracked-lock / --exit-iql-lock.
...
DEFAULT_EXIT_IQL_LOCK = Path(
    "/home/andre2/GX1_DATA/reports/truth_e2e_sanity/"
    "BUILD_EXIT_IQL_PER_BAR_DATASET_V12_V3PLUS_FULL_20260519T012648Z_LOCK_"
    "V3TRACKED_20260519T022946Z_LOCK_WINSORIZED_TRAINED_20260519T201758Z_LOCK"
)
