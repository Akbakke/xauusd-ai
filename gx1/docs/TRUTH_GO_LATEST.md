...
- **Exit ML:** `exit_ml_io_version` = EXIT_IO_V0_CTX19, `exit_ml_input_dim` = 19
...
Sitert fra footer: `ctx_cont_dim` 6, `ctx_cat_dim` 6, `exit_ml_io_version` EXIT_IO_V0_CTX19, `exit_ml_input_dim` 19, `status` ok.  
