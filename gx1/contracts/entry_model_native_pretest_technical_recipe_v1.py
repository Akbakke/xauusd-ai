...
REQUIRED_ARTIFACTS = frozenset(
    {
        ...
        "unified_exit_lifecycle_v2_root_manifest",
        "train_unified_exit_lifecycle_v2_parquet",
        "train_unified_exit_lifecycle_v2_manifest",
        "val_unified_exit_lifecycle_v2_parquet",
        "val_unified_exit_lifecycle_v2_manifest",
        "unified_exit_v2_economics_readiness",
        "train_unified_exit_v2_cost_authority",
        "val_unified_exit_v2_cost_authority",
        "m5_prebuilt",
