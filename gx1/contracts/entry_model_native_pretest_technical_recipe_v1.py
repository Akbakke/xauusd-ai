...
FORECAST_WARMUP_SMOKE_TRAINER_CLI_KEYS = SOURCE_BOUND_TEACHER_SMOKE_TRAINER_CLI_KEYS | {
    "forecast_only_warmup",
}
...
def require_pretest_technical_recipe_metadata(
    ...
    *,
    ...
    if trainer_cli_keys == FORECAST_WARMUP_SMOKE_TRAINER_CLI_KEYS:
        if trainer_cli["forecast_only_warmup"] is not True:
            raise PretestTechnicalRecipeError("forecast warmup must be explicitly true")
    if trainer_cli_keys in {INITIALIZED_SMOKE_TRAINER_CLI_KEYS, FORECAST_WARMUP_SMOKE_TRAINER_CLI_KEYS, FIXED_TEACHER_SMOKE_TRAINER_CLI_KEYS, SOURCE_BOUND_TEACHER_SMOKE_TRAINER_CLI_KEYS}:
    ...
    if trainer_cli_keys in {SOURCE_BOUND_TEACHER_SMOKE_TRAINER_CLI_KEYS, FORECAST_WARMUP_SMOKE_TRAINER_CLI_KEYS}:
