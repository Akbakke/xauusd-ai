...
class TradeJournal:
    ...
    def log_v12_bar_decision(
        ...
        exit_action_q_bps: list[float],
        exit_action_valid_mask: list[bool],
        ...
        exit_incremental_carry_envelope: Dict[str, Any],
        ...
        try:
            ...
            exit_output = {
                "exit_action_q_bps": list(exit_action_q_bps),
                "exit_action_valid_mask": list(exit_action_valid_mask),
                "exit_action_index": exit_action_index,
                "action": exit_action,
                "decision_source": exit_decision_source,
                "exit_input_envelope": dict(exit_input_envelope),
                "exit_incremental_carry_envelope": dict(
